...
</svg>`}function L(t){return t.replace(/([a-z])([A-Z])/g,"$1-$2").replace(/([0-9])([a-zA-Z])/g,"$1-$2").replace(/([a-zA-Z])([0-9])/g,"$1-$2").replace(/[\s_]+/g,"-").toLowerCase()}function vt(t){if(!t)return;let e=t.match(/var:preset\|spacing\|(.+)/);return e?`var(--wp--preset--spacing--${e[1]})`:t}function mo(t){if(!t)return null;let e=typeof t=="string";return{top:e?t:t?.top,left:e?t:t?.left}}function wt(t,e="0"){let o=mo(t);if(!o)return null;let r=vt(o?.top)||e,n=vt(o?.left)||e;return r===n?r:`${r} ${n}`}var ue={backgroundSize:"cover",backgroundPosition:"50% 50%"};function fe(t){if(!t||!t?.backgroundImage?.url)return;let e;return t?.backgroundSize||(e={backgroundSize:ue.backgroundSize}),t?.backgroundSize==="contain"&&!t?.backgroundPosition&&(e={backgroundPosition:ue.backgroundPosition}),e}var pe={default:{name:"default",slug:"flow",className:"is-layout-flow",baseStyles:[{selector:" > .alignleft",rules:{float:"left","margin-inline-start":"0","margin-inline-end":"2em"}},{selector:" > .alignright",rules:{float:"right","margin-inline-start":"2em","margin-inline-end":"0"}},{selector:" > .aligncenter",rules:{"margin-left":"auto !important","margin-right":"auto !important"}}],spacingStyles:[{selector:" > :first-child",rules:{"margin-block-start":"0"}},{selector:" > :last-child",rules:{"margin-block-end":"0"}},{selector:" > *",rules:{"margin-block-start":null,"margin-block-end":"0"}}]},constrained:{name:"constrained",slug:"constrained",className:"is-layout-constrained",baseStyles:[{selector:" > .alignleft",rules:{float:"left","margin-inline-start":"0","margin-inline-end":"2em"}},{selector:" > .alignright",rules:{float:"right","margin-inline-start":"2em","margin-inline-end":"0"}},{selector:" > .aligncenter",rules:{"margin-left":"auto !important","margin-right":"auto !important"}},{selector:" > :where(:not(.alignleft):not(.alignright):not(.alignfull))",rules:{"max-width":"var(--wp--style--global--content-size)","margin-left":"auto !important","margin-right":"auto !important"}},{selector:" > .alignwide",rules:{"max-width":"var(--wp--style--global--wide-size)"}}],spacingStyles:[{selector:" > :first-child",rules:{"margin-block-start":"0"}},{selector:" > :last-child",rules:{"margin-block-end":"0"}},{selector:" > *",rules:{"margin-block-start":null,"margin-block-end":"0"}}]},flex:{name:"flex",slug:"flex",className:"is-layout-flex",displayMode:"flex",baseStyles:[{selector:"",rules:{"flex-wrap":"wrap","align-items":"center"}},{selector:" > :is(*, div)",rules:{margin:"0"}}],spacingStyles:[{selector:"",rules:{gap:null}}]},grid:{name:"grid",slug:"grid",className:"is-layout-grid",displayMode:"grid",baseStyles:[{selector:" > :is(*, div)",rules:{margin:"0"}}],spacingStyles:[{selector:"",rules:{gap:null}}]}};var de={mobile:"480px",tablet:"782px"},ge=/^(\d+|\d*\.\d+)(px|em|rem)$/,ho=16;function yo(t){return"mobile"in t||"tablet"in t}function So(t){return!t||typeof t!="object"?{}:yo(t)?t:t.settings?.viewport??{}}function bo(t){return typeof t=="string"&&ge.test(t.trim())}function vo(t){if(typeof t=="number")return t;if(typeof t!="string")return;let e=t.trim().match(ge);if(!e)return;let o=Number.parseFloat(e[1]);return e[2]==="px"?o:o*ho}function wo(t){let e=So(t),o={},r={};Object.keys(de).forEach(a=>{let l=a,c=e[l],p=vo(c);p!==void 0&&bo(c)&&(o[l]=c.trim(),r[l]=p)});let n=Object.keys(o);if(!n.length)return{...de};if(n.length===1)return o;let s=o.mobile,i=o.tablet;return r.mobile>=r.tablet?{mobile:s}:{mobile:s,tablet:i}}function Et(t){let e=wo(t),o={};return e.mobile&&(o["@mobile"]=`@media (width <= ${e.mobile})`),e.tablet&&(o["@tablet"]=e.mobile?`@media (${e.mobile} < width <= ${e.tablet})`:`@media (width <= ${e.tablet})`),o}var Eo={button:"wp-element-button",caption:"wp-element-caption"},xo={__experimentalBorder:"border",color:"color",dimensions:"dimensions",spacing:"spacing",typography:"typography"},ye={"core/button":[":hover",":focus",":focus-visible",":active"],"core/navigation-link":[":hover",":focus",":focus-visible",":active"]},$o={link:[":link",":any-link",":visited",":hover",":focus",":focus-visible",":active"],button:[":link",":any-link",":visited",":hover",":focus",":focus-visible",":active"]};function _o(t="*",e={}){return H.reduce((o,{path:r,cssVarInfix:n,classes:s})=>{if(!s)return o;let i=v(e,r,[]);return["default","theme","custom"].forEach(a=>{i[a]&&i[a].forEach(({slug:l})=>{s.forEach(({classSuffix:c,propertyName:p})=>{let u=`.has-${L(l)}-${c}`,f=t?`:where(${t})${u}`:u,d=`var(--wp--preset--${n}--${L(l)})`;o+=`${f}{${p}: ${d} !important;}`})})}),o},"")}function ko(t={}){return H.filter(e=>e.path.at(-1)==="duotone").flatMap(e=>{let o=v(t,e.path,{});return["default","theme"].filter(r=>o[r]).flatMap(r=>o[r].map(n=>ce(`wp-duotone-${n.slug}`,n.colors))).join("")})}function Se(t={},e,o){let r=[];return Object.keys(t).forEach(n=>{let s=e+L(n.replace("/","-")),i=t[n];if(i instanceof Object){let a=s+o;r=[...r,...Se(i,a,o)]}else r.push(`${s}: ${i}`)}),r}var Oo=(t,e,o)=>{if(o!=="core/paragraph"||(e?.blocks?.["core/paragraph"]?.typography?.textIndent??e?.typography?.textIndent??"subsequent")!=="all")return t;let s=".wp-block-paragraph + .wp-block-paragraph",i=".wp-block-paragraph";if(s in t){let a=t[s],l={...t};return delete l[s],l[i]=a,l}return t},Po=(t,e)=>{let o=".wp-block-button";if(!(o in t))return t;let r={...t};return r[o]=r[o].map(n=>{let s=n.match(/^width:\s*(.+)$/);if(!s)return n;let i=s[1],a=null;i.endsWith("%")&&(a=parseFloat(i));let l="var(--wp--preset--dimension--";if(a===null&&i.startsWith(l)&&i.endsWith(")")){let c=i.slice(l.length,-1),p={...e?.dimensions?.dimensionSizes??{},...e?.blocks?.["core/button"]?.dimensions?.dimensionSizes??{}};for(let u of Object.values(p))if(Array.isArray(u)){for(let f of u)if(f.slug===c&&typeof f.size=="string"&&f.size.endsWith("%")){a=parseFloat(f.size);break}if(a!==null)break}}return a===null||isNaN(a)?n:`width: calc(${a} * 1% - (var(--wp--style--block-gap, 0.5em) * (1 - ${a} / 100)))`}),r},Io=(t,e)=>{let o={};return Object.entries(t).forEach(([r,n])=>{if(r==="root"||!e?.[r])return;let s=typeof n=="string";if(!s&&typeof n=="object"&&n!==null&&Object.entries(n).forEach(([i,a])=>{if(i==="root"||!e?.[r][i])return;let l={[r]:{[i]:e[r][i]}},c=lt(l);o[a]=[...o[a]||[],...c],delete e[r][i]}),s||typeof n=="object"&&n!==null&&"root"in n){let i=s?n:n.root,a={[r]:e[r]},l=lt(a);o[i]=[...o[i]||[],...l],delete e[r]}}),o};function lt(t={},e="",o,r={},n=!1){let s=R===e,i=Object.entries($.__EXPERIMENTAL_STYLE_PROPERTY).reduce((l,[c,{value:p,properties:u,useEngine:f,rootOnly:d}])=>{if(d&&!s)return l;let h=p;if(h[0]==="elements"||f)return l;let g=v(t,h);if(c==="--wp--style--root--padding"&&(typeof g=="string"||!o))return l;if(u&&typeof g!="string")Object.entries(u).forEach(m=>{let[y,w]=m;if(!v(g,[w],!1))return;let b=y.startsWith("--")?y:L(y);l.push(`${b}: ${(0,X.getCSSValueFromRawStyle)(v(g,[w]))}`)});else if(v(t,h,!1)){let m=c.startsWith("--")?c:L(c);l.push(`${m}: ${(0,X.getCSSValueFromRawStyle)(v(t,h))}`)}return l},[]);return t.background&&(t.background?.backgroundImage&&(t.background.backgroundImage=mt(t.background.backgroundImage,r)),!s&&t.background?.backgroundImage?.id&&(t={...t,background:{...t.background,...fe(t.background)}})),(0,X.getCSSRules)(t).forEach(l=>{if(s&&(o||n)&&l.key.startsWith("padding"))return;let c=l.key.startsWith("--")?l.key:L(l.key),p=mt(l.value,r);c==="font-size"&&(p=nt({name:"",slug:"",size:p},r?.settings)),c==="aspect-ratio"&&i.push("min-height: unset"),i.push(`${c}: ${p}`)}),i}function Vo({layoutDefinitions:t=pe,style:e,selector:o,hasBlockGapSupport:r,hasFallbackGapSupport:n,fallbackGapValue:s}){let i="",a=r?wt(e?.spacing?.blockGap):"";if(n&&(o===R?a=a||"0.5em":!r&&s&&(a=s)),a&&t&&(Object.values(t).forEach(({className:l,name:c,spacingStyles:p})=>{!r&&c!=="flex"&&c!=="grid"||p?.length&&p.forEach(u=>{let f=[];if(u.rules&&Object.entries(u.rules).forEach(([d,h])=>{f.push(`${d}: ${h||a}`)}),f.length){let d="";r?d=o===R?`:root :where(.${l})${u?.selector||""}`:`:root :where(${o}-${l})${u?.selector||""}`:d=o===R?`:where(.${l}${u?.selector||""})`:`:where(${o}.${l}${u?.selector||""})`,i+=`${d} { ${f.join("; ")}; }`}})}),o===R&&r&&(i+=`${K} { --wp--style--block-gap: ${a}; }`)),o===R&&t){let l=["block","flex","grid"];Object.values(t).forEach(({className:c,displayMode:p,baseStyles:u})=>{p&&l.includes(p)&&(i+=`${o} .${c} { display:${p}; }`),u?.length&&u.forEach(f=>{let d=[];if(f.rules&&Object.entries(f.rules).forEach(([h,g])=>{d.push(`${h}: ${g}`)}),d.length){let h=`.${c}${f?.selector||""}`;i+=`${h} { ${d.join("; ")}; }`}})})}return i}var Fo=["border","color","dimensions","spacing","typography","filter","outline","shadow","background"];function jo(t,e){return at(t,void 0,e)}function at(t,e,o){if(!t)return{};let r=Object.entries(t),n=e?ye[e]??[]:[],i=r.filter(([a])=>Fo.includes(a)||n.includes(a)||o[a]).map(([a,l])=>[a,JSON.parse(JSON.stringify(l))]);return Object.fromEntries(i)}function me(t){let{styles:e,selector:o,featureSelectors:r,name:n,elementName:s,mediaQuery:i,variationName:a}=t,l=n?ye[n]??[]:$o[s??""]??[];return l.length?l.flatMap(c=>{let p=e?.[c];return!p||typeof p!="object"?[]:[{styles:JSON.parse(JSON.stringify(p)),selector:o,selectorSuffix:c,mediaQuery:i,featureSelectors:r&&typeof r!="string"?r:void 0,name:n,elementName:s,variationName:a}]}):[]}function Ao(t,e){let{styles:o,selector:r,fallbackGapValue:n,featureSelectors:s,hasLayoutSupport:i,layoutHasBlockGapSupport:a,layoutSelector:l,name:c,elementName:p,isStyleVariation:u,variationName:f}=t;return!c&&!p?[]:Object.entries(e).flatMap(([d,h])=>{let g=o?.[d];return!g||typeof g!="object"?[]:[{styles:JSON.parse(JSON.stringify(g)),selector:r,mediaQuery:h,featureSelectors:s&&typeof s!="string"?s:void 0,fallbackGapValue:n,hasLayoutSupport:i,name:c,elementName:p,isStyleVariation:u,variationName:f,layoutSelector:l,layoutHasBlockGapSupport:a}]})}function xt(t,e){let o={...t?.elements??{}};return Object.keys(e).forEach(r=>{Object.entries(t?.[r]?.elements??{}).forEach(([n,s])=>{o[n]={...o[n]??{},[r]:s}})}),o}var Ro=(t,e)=>{let o=[];if(!t?.styles)return o;let r=Et(t),n=jo(t.styles,r);return n&&o.push({styles:n,selector:R,skipSelectorWrapper:!0}),Object.entries($.__EXPERIMENTAL_ELEMENTS).forEach(([s,i])=>{t.styles?.elements?.[s]&&o.push({styles:t.styles?.elements?.[s]??{},selector:i,elementName:s,skipSelectorWrapper:!Eo[s]})}),Object.entries(t.styles?.blocks??{}).forEach(([s,i])=>{let a=at(i,s,r),l=i,c=[],p=[];l?.variations&&Object.entries(l.variations).forEach(([u,f])=>{let d=f,h=at(d,s,r);d?.css&&(h.css=d.css);let g=typeof e!="string"?e[s]?.styleVariationSelectors?.[u]:void 0;if(g&&typeof e!="string"){let m=e[s];p.push({styles:h,selector:g,featureSelectors:m?.featureSelectors,fallbackGapValue:m?.fallbackGapValue,hasLayoutSupport:m?.hasLayoutSupport,isStyleVariation:!0,variationName:u,layoutSelector:g+m.selector,layoutHasBlockGapSupport:!0,name:s})}Object.entries(xt(d,r)).forEach(([m,y])=>{y&&$.__EXPERIMENTAL_ELEMENTS[m]&&c.push({styles:y,selector:I(g,$.__EXPERIMENTAL_ELEMENTS[m]),elementName:m,isStyleVariation:!0})}),Object.entries(d?.blocks??{}).forEach(([m,y])=>{let w=typeof e!="string"?I(g,e[m]?.selector):void 0,b=typeof e!="string"?I(g,e[m]?.duotoneSelector):void 0,E=typeof e!="string"?Ht(g,e[m]?.featureSelectors??{}):void 0,_=at(y,m,r);y?.css&&(_.css=y.css),!(!w||typeof e=="string")&&(c.push({selector:w,name:m,isStyleVariation:!0,duotoneSelector:b,featureSelectors:E,fallbackGapValue:e[m]?.fallbackGapValue,hasLayoutSupport:e[m]?.hasLayoutSupport,styles:_}),Object.entries(xt(y,r)).forEach(([k,C])=>{C&&$.__EXPERIMENTAL_ELEMENTS[k]&&c.push({styles:C,selector:I(w,$.__EXPERIMENTAL_ELEMENTS[k]),elementName:k,isStyleVariation:!0})}))})}),typeof e!="string"&&e?.[s]?.selector&&o.push({duotoneSelector:e[s].duotoneSelector,fallbackGapValue:e[s].fallbackGapValue,hasLayoutSupport:e[s].hasLayoutSupport,selector:e[s].selector,styles:a,featureSelectors:e[s].featureSelectors,name:s}),o.push(...p),Object.entries(xt(l,r)).forEach(([u,f])=>{typeof e!="string"&&f&&e?.[s]&&$.__EXPERIMENTAL_ELEMENTS[u]&&o.push({styles:f,selector:e[s]?.selector.split(",").map(d=>$.__EXPERIMENTAL_ELEMENTS[u].split(",").map(g=>d+" "+g)).join(","),elementName:u})}),o.push(...c)}),o},$t=(t,e)=>{let o=[];if(!t?.settings)return o;let r=i=>{let a={};return H.forEach(({path:l})=>{let c=v(i,l,!1);c!==!1&&(a=rt(a,l,c))}),a},n=r(t.settings),s=t.settings?.custom;return(Object.keys(n).length>0||s)&&o.push({presets:n,custom:s,selector:K}),Object.entries(t.settings?.blocks??{}).forEach(([i,a])=>{let l=a.custom;if(typeof e=="string"||!e[i])return;let c=r(a);(Object.keys(c).length>0||l)&&o.push({presets:c,custom:l,selector:e[i]?.selector,featureSelectors:e[i]?.featureSelectors})}),o};function To(t,e,o){if(!t||typeof t=="string")return o;let r=t[e];return typeof r=="string"?r:typeof r=="object"&&r.root?r.root:o}function Co(t,e,{path:o,valueKey:r,valueFunc:n,cssVarInfix:s}){let i=v(t,o,[]),a=[];for(let l of["default","theme","custom"])if(i[l])for(let c of i[l]){let p=L(c.slug);r&&!n?a.push(`--wp--preset--${s}--${p}: ${c[r]}`):n&&typeof n=="function"&&a.push(`--wp--preset--${s}--${p}: ${n(c,e)}`)}return a}var Lo=(t,e)=>{let o=$t(t,e),r="";for(let{presets:n,custom:s,selector:i,featureSelectors:a}of o){let l=i,c={[l]:[]};if(t?.settings)for(let u of H){let f=Co(n,t.settings,u);if(f.length===0)continue;let d=To(a,u.path[0],l);c[d]||(c[d]=[]),c[d].push(...f)}let p=Se(s,"--wp--custom--","--");p.length>0&&c[l].push(...p);for(let[u,f]of Object.entries(c))f.length>0&&(r+=`${u}{${f.join(";")};}`)}return r};function zo(t,{tree:e,useRootPaddingAlign:o,disableLayoutStyles:r,hasBlockGapSupport:n,hasFallbackGapSupport:s,disableRootPadding:i}){let{selector:a,selectorSuffix:l,mediaQuery:c,duotoneSelector:p,styles:u,fallbackGapValue:f,hasLayoutSupport:d,featureSelectors:h,layoutSelector:g,layoutHasBlockGapSupport:m,skipSelectorWrapper:y,name:w,variationName:b}=t,E="",_=l?st(a,l):a;if(h&&typeof h!="string"){let j=Io(h,u);j=Oo(j,e.settings,w),j=Po(j,e.settings),Object.entries(j).forEach(([W,At])=>{if(At.length){let et=b?Jt(b,W):W;et=l?st(et,l):et;let We=At.join(";");E+=`:root :where(${et}){${We};}`}})}if(p){let j={};u?.filter&&(j.filter=u.filter,delete u.filter);let W=lt(j);W.length&&(E+=`${p}{${W.join(";")};}`)}let k=g??_;!r&&(R===k||d)&&(E+=Vo({style:u,selector:k,hasBlockGapSupport:m??n,hasFallbackGapSupport:s,fallbackGapValue:f}));let jt=lt(u,_,o,e,i);if(jt?.length){let j=y?_:`:root :where(${_})`;E+=`${j}{${jt.join(";")};}`}return u?.css&&(E+=be(u.css,`:root :where(${_})`)),c&&E?`${c}{${E}}`:E}var Mo=(t,e,o,r,n=!1,s=!1,i={})=>{let a={blockGap:!0,blockStyles:!0,layoutStyles:!0,marginReset:!0,presets:!0,rootPadding:!0,variationStyles:!1,...i},l=t,c=Ro(l,e),p=$t(l,e),u=l?.settings?.useRootPaddingAwareAlignments,{contentSize:f,wideSize:d}=l?.settings?.layout||{},h=a.marginReset||a.rootPadding||a.layoutStyles,g="";if(a.presets&&(f||d)&&(g+=`${K} {`,g=f?g+` --wp--style--global--content-size: ${f};`:g,g=d?g+` --wp--style--global--wide-size: ${d};`:g,g+="}"),h&&(g+=":where(body) {margin: 0;",a.rootPadding&&u&&(g+=`padding-right: 0; padding-left: 0; padding-top: var(--wp--style--root--padding-top); padding-bottom: var(--wp--style--root--padding-bottom) }
				.has-global-padding { padding-right: var(--wp--style--root--padding-right); padding-left: var(--wp--style--root--padding-left); }
				.has-global-padding > .alignfull { margin-right: calc(var(--wp--style--root--padding-right) * -1); margin-left: calc(var(--wp--style--root--padding-left) * -1); }
				.has-global-padding :where(:not(.alignfull.is-layout-flow) > .has-global-padding:not(.wp-block-block, .alignfull)) { padding-right: 0; padding-left: 0; }
				.has-global-padding :where(:not(.alignfull.is-layout-flow) > .has-global-padding:not(.wp-block-block, .alignfull)) > .alignfull { margin-left: 0; margin-right: 0;
				`),g+="}"),a.blockStyles){let m=Et(t);c.forEach(y=>{if(y.isStyleVariation&&!a.variationStyles)return;let w=Ao(y,m);[y,...w,...me(y),...w.flatMap(me)].forEach(b=>{g+=zo(b,{tree:l,useRootPaddingAlign:u,disableLayoutStyles:n,hasBlockGapSupport:o,hasFallbackGapSupport:r,disableRootPadding:s})})})}if(a.layoutStyles&&(g=g+".wp-site-blocks > .alignleft { float: left; margin-right: 2em; }",g=g+".wp-site-blocks > .alignright { float: right; margin-left: 2em; }",g=g+".wp-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }"),a.blockGap&&o){let m=wt(l?.styles?.spacing?.blockGap)||"0.5em";g=g+`:root :where(.wp-site-blocks) > * { margin-block-start: ${m}; margin-block-end: 0; }`,g=g+":root :where(.wp-site-blocks) > :first-child { margin-block-start: 0; }",g=g+":root :where(.wp-site-blocks) > :last-child { margin-block-end: 0; }"}return a.presets&&p.forEach(({selector:m,presets:y})=>{(R===m||K===m)&&(m="");let w=_o(m,y);w.length>0&&(g+=w)}),g};function No(t,e){return $t(t,e).flatMap(({presets:r})=>ko(r))}var Go=(t,e)=>{if(t?.selectors&&Object.keys(t.selectors).length>0)return t.selectors;let o={root:e};return Object.entries(xo).forEach(([r,n])=>{let s=B(t,r);s&&(o[n]=s)}),o},Bo=(t,e)=>{let{getBlockStyles:o}=(0,he.select)($.store),r={};return t.forEach(n=>{let s=n.name,i=B(n);if(!i)return;let a=B(n,"filter.duotone");if(!a){let d=B(n),h=(0,$.getBlockSupport)(n,"color.__experimentalDuotone",!1);typeof h=="string"&&d&&(a=I(d,h))}let l=!!n?.supports?.layout||!!n?.supports?.__experimentalLayout,c=n?.supports?.spacing?.blockGap?.__experimentalDefault,p=o(s),u={};p?.forEach(d=>{let h=e?`-${e}`:"",g=`${d.name}${h}`,m=gt(g,i);u[g]=m});let f=Go(n,i);r[s]={duotoneSelector:a??void 0,fallbackGapValue:c,featureSelectors:Object.keys(f).length?f:void 0,hasLayoutSupport:l,name:s,selector:i,styleVariationSelectors:p?.length?u:void 0}}),r};function Wo(t){let e=t.styles?.blocks,o=e?.["core/separator"];return o&&o.color?.background&&!o.color?.text&&!o.border?.color?{...t,styles:{...t.styles,blocks:{...e,"core/separator":{...o,color:{...o.color,text:o.color?.background}}}}}:t}function be(t,e){let o="";return!t||t.trim()===""||t.split("&").forEach(n=>{if(!n||n.trim()==="")return;if(!n.includes("{"))o+=`:root :where(${e}){${n.trim()}}`;else{let i=n.replace("}","").split("{");if(i.length!==2)return;let[a,l]=i,c=a.match(/([>+~\s]*::[a-zA-Z-]+)/),p=c?c[1]:"",u=c?a.replace(p,"").trim():a.trim(),f;u===""?f=e:f=a.startsWith(" ")?I(e,u):st(e,u),o+=`:root :where(${f})${p}{${l.trim()}}`}}),o}function _t(t={},e=[],o={}){let{hasBlockGapSupport:r,hasFallbackGapSupport:n,disableLayoutStyles:s=!1,disableRootPadding:i=!1,styleOptions:a={}}=o,l=e.length>0?e:(0,$.getBlockTypes)(),c=Wt(t,"spacing.blockGap"),p=r??c!==null,u=n??!p;if(!t?.styles||!t?.settings)return[[],{}];let f=Wo(t),d=Bo(l),h=Lo(f,d),g=Mo(f,d,p,u,s,i,a),m=No(f,d),y=[{css:h,isGlobalStyles:!0},{css:g,isGlobalStyles:!0},{css:f?.styles?.css??"",isGlobalStyles:!0},{assets:m,__unstableType:"svgs",isGlobalStyles:!0}];return l.forEach(w=>{let b=f?.styles?.blocks?.[w.name];if(b?.css){let{featureSelectors:E}=d[w.name],_=typeof E=="object"?E?.css:void 0,k;typeof _=="string"?k=_:typeof _=="object"&&(k=_?.root);let C=k??d[w.name].selector;y.push({css:be(b.css,C),isGlobalStyles:!0})}}),[y,f.settings]}var Oe=S(N(),1),kt=S(G(),1),Pe=S(M(),1);var Ee=S(N(),1),xe=S(M(),1),$e=S(G(),1);function _e(t){let{userGlobalStyles:e}=(0,xe.useSelect)(o=>{let{getEntityRecord:r,getEditedEntityRecord:n,canUser:s}=o(Ee.store),i=s("update",{kind:"root",name:"globalStyles",id:t}),a;return typeof i=="boolean"&&(i?a=n("root","globalStyles",t):a=r("root","globalStyles",t,{context:"view"})),{userGlobalStyles:a}},[t]);return(0,$e.useMemo)(()=>e?{user:e}:{user:void 0},[e])}var ke=S(we(),1),{unlock:F}=(0,ke.__dangerousOptInToUnstableAPIsOnlyForCoreModules)("I acknowledge private features are not for use in themes or plugins and doing so will break in the next version of WordPress.","@wordpress/lazy-editor");function Y({stylesId:t}){let{editorSettings:e}=(0,Pe.useSelect)(i=>({editorSettings:F(i(Oe.store)).getEditorSettings()}),[]),{user:o}=_e(t),[r]=_t(o),n=!!e,s=(0,kt.useMemo)(()=>n?[...e?.styles??[],...r]:[],[n,e?.styles,r]);return{isReady:n,editorSettings:(0,kt.useMemo)(()=>({...e??{},styles:s}),[e,s])}}function Uo(t){if(!t||Object.keys(t).length===0)return;let e=document.querySelector("script#wp-importmap[type=importmap]");if(e)try{let o=JSON.parse(e.text);o.imports||(o.imports={}),o.imports={...o.imports,...t},e.text=JSON.stringify(o,null,2)}catch(o){console.error("Failed to parse or update import map:",o)}else{let o=document.createElement("script");o.type="importmap",o.id="wp-importmap",o.text=JSON.stringify({imports:t},null,2),document.head.appendChild(o)}}function Do(t,e){return new Promise(o=>{if(!e.src){o();return}if(document.getElementById(t+"-css")){o();return}let n=document.createElement("link");n.rel="stylesheet",n.href=e.src+(e.version?"?ver="+e.version:""),n.id=t+"-css",n.media=e.media||"all",n.onload=()=>o(),n.onerror=()=>{console.error(`Failed to load stylesheet: ${t}`),o()},document.head.appendChild(n)})}function Ko(t,e){if(!e.src){let r=document.createElement("script");return r.id=t+"-js",r.textContent="// Processed: "+t,r}let o=document.createElement("script");return o.src=e.src+(e.version?"?ver="+e.version:""),o.id=t+"-js",o.async=!1,o}function Ie(t,e,o){let r="";if(Array.isArray(e)?r=e.join(`
`):typeof e=="string"&&(r=e),r&&r.trim()){let n=t+"-"+o+"-inline-css";if(!document.getElementById(n)){let s=document.createElement("style");s.id=n,s.textContent=r.trim(),document.head.appendChild(s)}}}function Ve(t,e,o){let r=e;Array.isArray(r)&&(r=r.join(`
`));let n=document.createElement("script");return n.id=t+"-"+o+"-js",n.textContent=r.trim(),n}function Fe(t){let e=new Set,o=new Set,r=[];function n(s){if(!e.has(s)){if(o.has(s)){console.warn(`Circular dependency detected for handle: ${s}`);return}o.add(s),t[s]&&(t[s].deps||[]).forEach(a=>{t[a]&&n(a)}),o.delete(s),e.add(s),t[s]&&r.push(s)}}return Object.keys(t).forEach(s=>{n(s)}),r}async function Ho(t,e){let o=[];for(let r of t){if(r.src){let n=Promise.withResolvers();r.onload=()=>n.resolve(),r.onerror=()=>{console.error(`Failed to load script: ${r.id}`),n.resolve()},o.push(n.promise)}else await Promise.all(o),o=[];e.appendChild(r)}await Promise.all(o),o=[]}async function Jo(t,e,o,r,n,s){s&&Uo(s);let i=Fe(o),a=Fe(t),l=[];for(let u of i){let f=r.before?.[u];f&&Ie(u,f,"before"),l.push(Do(u,o[u]));let d=r.after?.[u];d&&Ie(u,d,"after")}let c=[];for(let u of a){let f=e.before?.[u];f&&c.push(Ve(u,f,"before")),c.push(Ko(u,t[u]));let d=e.after?.[u];d&&c.push(Ve(u,d,"after"))}let p=Ho(c,document.body);await Promise.all([Promise.all(l),p]),n&&n.length>0&&n.forEach(u=>{let f=u.match(/<script([^>]*)>(.*?)<\/script>/is);if(f){let d=f[1],h=f[2],g=document.createElement("script"),m=d.match(/id=["']([^"']+)["']/);m&&(g.id=m[1]);let y=d.match(/type=["']([^"']+)["']/);y&&(g.type=y[1]),g.textContent=h,document.body.appendChild(g)}})}var je=Jo;var Pt=S(N(),1),ct=S(G(),1),ut=S(M(),1);var Ot;async function Ae(){return Ot||(Ot=(async()=>{let e=await F((0,ut.resolveSelect)(Pt.store)).getEditorAssets();await je(e.scripts||{},e.inline_scripts||{before:{},after:{}},e.styles||{},e.inline_styles||{before:{},after:{}},e.html_templates||[],e.script_modules||{})})()),Ot}function Z(){let t=(0,ut.useSelect)(r=>F(r(Pt.store)).getEditorAssets(),[]),[e,o]=(0,ct.useState)(!1);return(0,ct.useEffect)(()=>{t&&!e&&Ae().then(()=>{o(!0)}).catch(r=>{console.error("Failed to load editor assets:",r)})},[t,e]),{isReady:!!t&&e,assetsLoaded:e}}var Q=S(It(),1),{Editor:Xo,BackButton:Yo}=F(Te.privateApis);function Zo({postType:t,postId:e,settings:o,backButton:r}){let n=(0,Ft.useSelect)(d=>{if(t||e)return null;let{getHomePage:h}=F(d(Vt.store));return h()},[t,e]),s=t||n?.postType,i=e||n?.postId,a=(0,Ft.useSelect)(d=>{if(!(!s||!i))return s==="wp_template"?i:F(d(Vt.store)).getTemplateId(s,i)},[s,i]),l=ot({templateId:a}),{isReady:c,editorSettings:p}=Y({stylesId:l}),{isReady:u}=Z(),f=(0,Le.useMemo)(()=>({...p,...o}),[p,o]);return!c||!u?(0,Q.jsx)("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100vh"},children:(0,Q.jsx)(Ce.Spinner,{})}):(0,Q.jsx)(Xo,{postType:s,postId:i,templateId:a,settings:f,styles:f.styles,children:r&&(0,Q.jsx)(Yo,{children:r})})}var Ne=S(Yt(),1),tt=S(G(),1),q=S(Me(),1),Ge=S(ft(),1),Be=S(ht(),1);var z=S(It(),1);if(typeof document<"u"&&!document.head.querySelector("style[data-wp-hash='95327475c1']")){let t=document.createElement("style");t.setAttribute("data-wp-hash","95327475c1"),t.appendChild(document.createTextNode(".lazy-editor-block-preview__container{align-items:center;border-radius:4px;display:flex;flex-direction:column;height:100%;justify-content:center}.dataviews-view-grid .lazy-editor-block-preview__container .block-editor-block-preview__container{height:100%}.dataviews-view-table .lazy-editor-block-preview__container{text-wrap:balance;text-wrap:pretty;flex-grow:0;width:96px}")),document.head.appendChild(t)}var{useStyle:Qo}=F(Ge.privateApis);function qo({blocks:t,content:e,description:o}){let r=(0,tt.useId)(),n=Qo("color.background"),s=(0,tt.useMemo)(()=>t??(0,Be.parse)(e,{__unstableSkipMigrationLogs:!0}),[e,t]),i=!s?.length;return(0,z.jsxs)("div",{className:"lazy-editor-block-preview__container",style:{backgroundColor:n},"aria-describedby":o?r:void 0,children:[i&&(0,Ne.__)("Empty."),!i&&(0,z.jsx)(q.BlockPreview.Async,{children:(0,z.jsx)(q.BlockPreview,{blocks:s})}),!!o&&(0,z.jsx)("div",{hidden:!0,id:r,children:o})]})}function tr({blocks:t,content:e,description:o}){let r=ot(),{isReady:n,editorSettings:s}=Y({stylesId:r}),{isReady:i}=Z(),a=(0,tt.useMemo)(()=>({...s,isPreviewMode:!0}),[s]);return!n||!i?null:(0,z.jsx)(q.BlockEditorProvider,{settings:a,children:(0,z.jsx)(qo,{blocks:t,content:e,description:o})})}export{Zo as Editor,tr as Preview,Ae as loadEditorAssets,Z as useEditorAssets,Y as useEditorSettings};
