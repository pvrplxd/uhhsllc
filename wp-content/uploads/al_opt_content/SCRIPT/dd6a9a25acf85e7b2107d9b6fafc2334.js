! ( function() {
	var n = function( t, e, s, u ) {
			var r; e[0] = 0; for ( var h = 1; h < e.length; h++ ) {
				var p = e[h++],
					a = e[h] ? ( e[0] |= p ? 1 : 2, s[e[h++]] ) : e[++h]; 3 === p ? u[0] = a : 4 === p ? u[1] = Object.assign( u[1] || {}, a ) : 5 === p ? ( u[1] = u[1] || {} )[e[++h]] = a : 6 === p ? u[1][e[++h]] += a + '' : p ? ( r = t.apply( a, n( t, a, s, [ '', null ] ) ), u.push( r ), a[0] ? e[0] |= 2 : ( e[h - 2] = 0, e[h] = r ) ) : u.push( a );
			} return u;
		},
		t = new Map,
		e = function( e ) {
			var s = t.get( this ); return s || ( s = new Map, t.set( this, s ) ), ( s = n( this, s.get( e ) || ( s.set( e, s = ( function( n ) {
				for ( var t, e, s = 1, u = '', r = '', h = [ 0 ], p = function( n ) {
					...
					a && ( 1 === s && p(), p( a ) ); for ( var o = 0; o < n[a].length; o++ ) {
