...
( function( $ ) {
	...
	wp.customize( 'astra-settings[edd-checkout-content-width]', function( setting ) {
		setting.bind( function( value ) {
			...
			const tabletBreakpoint = ( typeof astraPreviewHelper !== 'undefined' ) ? astraPreviewHelper.tabletBreakPoint : 768;
			if ( 'custom' === value ) {

				dynamicStyle += '@media (min-width: ' + ( parseInt( tabletBreakpoint ) + 1 ) + 'px) {'
