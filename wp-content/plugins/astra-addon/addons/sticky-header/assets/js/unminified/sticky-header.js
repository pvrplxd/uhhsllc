 ...
 */
 ...
 ;(function ( $, window, undefined ) {
	...
	if ( stick_main || stick_above || stick_below ) {
		...
		} // end astStickyHeaderInit

		// DOM ready — works in jQuery 3.7.1 AND 4.0
		jQuery(function($) {
			astStickyHeaderInit();
		});

		// Custom event — .on() with custom events still works in jQuery 4.0
		jQuery(document).on( 'astLayoutWidthChanged', function(e) {
