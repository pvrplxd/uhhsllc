...
( function( $ ) {
	...
	astra_css( 'astra-settings[post-meta-link-h-color]', 'color', '.read-more a:not(.ast-button):hover, .entry-meta a:hover, .post-content .ast-blog-single-element .entry-meta a:hover *');
	 ...
	 */
	astra_css( 'astra-settings[blog-tax-border-color]', 'border-color', '.ast-blog-single-element.ast-taxonomy-container a', '', false, 'border: 1px solid;');
	astra_css( 'astra-settings[blog-tax-border-h-color]', 'border-color', '.ast-blog-single-element.ast-taxonomy-container a:hover', '', false, 'border: 1px solid;');
	...
	/**
	 * Blog / Archive: Cover Layout: Text Content Background Color
	 */
	astra_css(
		'astra-settings[post-card-content-text-background]',
		'background-color',
		'div.ast-blog-layout-6-grid .blog-layout-6 .ast-blog-single-element *',
		undefined,
		false,
		'display: inline;'
	);
	 ...
	 * Sidebar
	 */
	astra_css( 'astra-settings[sidebar-widget-title-color]', 'color', '.widget-area.secondary .sidebar-main .wp-block-heading');
