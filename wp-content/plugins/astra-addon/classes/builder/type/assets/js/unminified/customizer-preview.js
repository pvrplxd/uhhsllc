...
( function( $ ) {
    ...
    astra_addon_button_css( 'header', astraBuilderPreview.component_limit );
...
( function( $ ) {
    astra_builder_divider_css( 'header', astraBuilderPreview.component_limit );
} )( jQuery );
...
( function( $ ) {
  ...
  for ( var index = 1; index <= astraBuilderPreview.component_limit; index++ ) {
...
( function( $ ) {
    ...
    astra_builder_addon_social_css( 'header', astraBuilderPreview.component_limit );
...
( function( $ ) {
    astra_builder_color_switcher_css( 'header' );
} )( jQuery );
...
( function( $ ) {
    ...
    astra_addon_button_css( 'footer', astraBuilderPreview.component_limit );
...
( function( $ ) {
	...
	astra_builder_divider_css( 'footer', astraBuilderPreview.component_limit );
...
( function( $ ) {
    ...
    astra_builder_addon_social_css( 'footer', astraBuilderPreview.component_limit );
