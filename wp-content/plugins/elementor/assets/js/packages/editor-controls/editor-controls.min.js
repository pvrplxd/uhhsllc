...
`,SortableTrigger=r=>ln.createElement("div",{...r,role:"button",className:"class-item-sortable-trigger",tabIndex:0,"aria-label":(0,pn.__)("Drag item","elementor")},ln.createElement(cn.GripVerticalIcon,{fontSize:"tiny"})),hn=(0,un.styled)(un.Divider)`
	height: 0px;
	border: none;
	overflow: visible;
	...
	&:after {
		...
		border-radius: ${({theme:r})=>r.spacing(.5)};
		background-color: ${({theme:r})=>r.palette.text.primary};
	}
`,ItemsContainer=({isSortable:r=!0,children:o})=>{const{items:i,setItems:a}=useRepeaterContext(),c=i.map(({key:r})=>r);if(!o)return null;return sn.createElement(sn.Fragment,null,sn.createElement(SortableProvider,{value:c,onChange:r=>{a(r.map(r=>{const o=i.findIndex(o=>o.key===r);return i[o]}))}},c.map((a,c)=>{const u=i[c].item;return sn.createElement(SortableItem,{id:a,key:`sortable-${a}`,disabled:!r},sn.createElement(nn.Provider,{value:{index:c,value:u}},o))})))},mn=__toESM(i(97557)),gn=i(97557),vn=i(79513),yn=i(27723),bn=i(97557),kn=(0,bn.createContext)(void 0),useRepeatableControlContext=()=>{const r=(0,bn.useContext)(kn);if(!r)throw new Error("useRepeatableControlContext must be used within RepeatableControl");return r},En=__toESM(i(97557)),Sn=i(97557),wn=i(79513),xn=(0,Sn.forwardRef)((r,o)=>En.createElement(wn.UnstableTag,{ref:o,fullWidth:!0,showActionsOnHover:!0,variant:"outlined",sx:{minHeight:r=>r.spacing(3.5)},...r})),Cn=i(87627),{Slot:_n,inject:Tn}=(0,Cn.createReplaceableLocation)(),{Slot:On,inject:Pn}=(0,Cn.createReplaceableLocation)(),{Slot:An,inject:Mn}=(0,Cn.createLocation)(),Item=({Label:r,Icon:o,actions:i})=>{const{popoverState:a,setRowRef:c,openItemIndex:u,setOpenItemIndex:p,index:g=-1,value:v,isItemDisabled:b}=useRepeaterContext(),k=(0,gn.useContext)(kn),E=!!k?.props?.readOnly,w=(0,vn.bindTrigger)(a);return mn.createElement(xn,{ref:r=>{r&&u===g&&r!==a.anchorEl&&(c(r),a.setAnchorEl(r))},label:mn.createElement(On,{value:v},mn.createElement(r,{value:v})),"aria-label":(0,yn.__)("Open item","elementor"),...w,onClick:r=>{E||b(g)||(w.onClick(r),p(g))},startIcon:mn.createElement(_n,{value:v},mn.createElement(o,{value:v})),sx:{minHeight:r=>r.spacing(3.5),...b(g)&&{'[role="button"]':{cursor:"not-allowed"}}},actions:mn.createElement(mn.Fragment,null,mn.createElement(An,{index:g??-1}),i)})},Nn=__toESM(i(97557)),ControlRepeater=({children:r,initial:o,propTypeUtil:i,isItemDisabled:a})=>Nn.createElement(SectionContent,null,Nn.createElement(RepeaterContextProvider,{initial:o,propTypeUtil:i,isItemDisabled:a},r)),Rn=__toESM(i(97557)),In=i(24413),Dn=i(79513),Ln=i(27723),Fn="tiny",DisableItemAction=()=>{const{items:r,updateItem:o,index:i=-1}=useRepeaterContext();if(-1===i)return null;const a=r[i].item.disabled??!1,c=a?(0,Ln.__)("Show","elementor"):(0,Ln.__)("Hide","elementor");return Rn.createElement(Dn.Tooltip,{title:c,placement:"top"},Rn.createElement(Dn.IconButton,{size:Fn,onClick:()=>{const a=structuredClone(r[i].item);a.disabled=!a.disabled,a.disabled||delete a.disabled,o(a,i)},"aria-label":c},a?Rn.createElement(In.EyeOffIcon,{fontSize:Fn}):Rn.createElement(In.EyeIcon,{fontSize:Fn})))},zn=__toESM(i(97557)),jn=i(24413),Bn=i(79513),Vn=i(27723),$n="tiny",DuplicateItemAction=()=>{const{items:r,addItem:o,index:i=-1,isItemDisabled:a}=useRepeaterContext();if(-1===i)return null;const c=(0,Vn.__)("Duplicate","elementor"),u=r[i]?.item;return zn.createElement(Bn.Tooltip,{title:c,placement:"top"},zn.createElement(Bn.IconButton,{size:$n,onClick:r=>{const a=structuredClone(u);o(r,{item:a,index:i+1})},"aria-label":c,disabled:a(i)},zn.createElement(jn.CopyIcon,{fontSize:$n})))},Un=__toESM(i(97557)),Hn=i(24413),Wn=i(79513),qn=i(27723),Kn="tiny",RemoveItemAction=()=>{const{removeItem:r,index:o=-1}=useRepeaterContext();if(-1===o)return null;const i=(0,qn.__)("Remove","elementor");return Un.createElement(Wn.Tooltip,{title:i,placement:"top"},Un.createElement(Wn.IconButton,{size:Kn,onClick:()=>r(o),"aria-label":i},Un.createElement(Hn.XIcon,{fontSize:Kn})))},Gn=__toESM(i(97557)),Jn=i(79513),Yn=__toESM(i(97557)),Xn=i(79513),RepeaterPopover=({children:r,width:o,...i})=>Yn.createElement(Xn.Popover,{disablePortal:!0,disableEnforceFocus:!0,anchorOrigin:{vertical:"bottom",horizontal:"left"},slotProps:{paper:{sx:{marginBlockStart:.5,width:o,overflow:"visible"}}},...i},r),EditItemPopover=({children:r})=>{const{popoverState:o,openItemIndex:i,isOpen:a,rowRef:c,setOpenItemIndex:u,setRowRef:p}=useRepeaterContext();if(!a||!c)return null;return Gn.createElement(RepeaterPopover,{width:c.offsetWidth,...(0,Jn.bindPopover)(o),onClose:()=>{p(null),o.setAnchorEl(null),u(-1)}},Gn.createElement(PropKeyProvider,{bind:String(i)},Gn.createElement(Jn.Box,null,r)))},Qn=__toESM(i(97557)),Zn=i(79513),PopoverContent=({gap:r=1.5,children:o,...i})=>Qn.createElement(Zn.Stack,{...i,gap:r},o),er=i(97557),nr=__toESM(i(97557)),rr=i(79513),or=(0,er.forwardRef)(({gap:r=1.5,alignItems:o="center",flexWrap:i="nowrap",children:a},c)=>nr.createElement(rr.Grid,{container:!0,gap:r,alignItems:o,flexWrap:i,ref:c},a)),ir=__toESM(i(97557)),ar=i(97557),sr=i(79513),lr=(0,ar.forwardRef)(({label:r,children:o,adornment:i=ControlAdornments},a)=>ir.createElement(sr.Stack,{direction:"row",alignItems:"center",gap:1,sx:{marginInlineEnd:-.75,py:.25},ref:a},ir.createElement(sr.Box,{display:"flex",alignItems:"center",gap:1,sx:{flexGrow:1}},ir.createElement(sr.Typography,{component:"label",variant:"caption",color:"text.secondary",sx:{lineHeight:1}},r),ir.createElement(i,null)),o)),cr=createControl(()=>{const{propType:r,value:o,setValue:i,disabled:a}=useBoundProp(Ut.boxShadowPropTypeUtil);return Vt.createElement(PropProvider,{propType:r,value:o,setValue:i,isDisabled:()=>a},Vt.createElement(ControlRepeater,{initial:pr,propTypeUtil:Ut.boxShadowPropTypeUtil},Vt.createElement(lr,{label:(0,Wt.__)("Box shadow","elementor")},Vt.createElement(TooltipAddItemAction,{newItemIndex:0,disabled:a,ariaLabel:"Box shadow"})),Vt.createElement(ItemsContainer,null,Vt.createElement(Item,{Icon:ItemIcon,Label:ItemLabel,actions:Vt.createElement(Vt.Fragment,null,Vt.createElement(DuplicateItemAction,null),Vt.createElement(DisableItemAction,null),Vt.createElement(RemoveItemAction,null))})),Vt.createElement(EditItemPopover,null,Vt.createElement(Content,null))))}),ur=(0,Ht.styled)(Ht.UnstableColorIndicator)(({theme:r})=>({height:"1rem",width:"1rem",borderRadius:r.shape.borderRadius/2+"px"})),ItemIcon=({value:r})=>Vt.createElement(ur,{size:"inherit",component:"span",value:r.value.color?.value}),Content=()=>{const r=useBoundProp(Ut.shadowPropTypeUtil),o=[(0,$t.useRef)(null),(0,$t.useRef)(null)],{rowRef:i}=useRepeaterContext();return Vt.createElement(PropProvider,{...r},Vt.createElement(PopoverContent,{p:1.5},Vt.createElement(or,null,Vt.createElement(Control2,{bind:"color",label:(0,Wt.__)("Color","elementor")},Vt.createElement(Ft,{anchorEl:i})),Vt.createElement(Control2,{bind:"position",label:(0,Wt.__)("Position","elementor"),sx:{overflow:"hidden"}},Vt.createElement(_e,{options:[{label:(0,Wt.__)("Inset","elementor"),value:"inset"},{label:(0,Wt.__)("Outset","elementor"),value:null}]}))),Vt.createElement(or,{ref:o[0]},Vt.createElement(Control2,{bind:"hOffset",label:(0,Wt.__)("Horizontal","elementor")},Vt.createElement(_t,{anchorRef:o[0],min:-Number.MAX_SAFE_INTEGER})),Vt.createElement(Control2,{bind:"vOffset",label:(0,Wt.__)("Vertical","elementor")},Vt.createElement(_t,{anchorRef:o[0],min:-Number.MAX_SAFE_INTEGER}))),Vt.createElement(or,{ref:o[1]},Vt.createElement(Control2,{bind:"blur",label:(0,Wt.__)("Blur","elementor")},Vt.createElement(_t,{anchorRef:o[1]})),Vt.createElement(Control2,{bind:"spread",label:(0,Wt.__)("Spread","elementor")},Vt.createElement(_t,{anchorRef:o[1],min:-Number.MAX_SAFE_INTEGER})))))},Control2=({label:r,bind:o,children:i,sx:a})=>Vt.createElement(PropKeyProvider,{bind:o},Vt.createElement(Ht.Grid,{item:!0,xs:6,sx:a},Vt.createElement(Ht.Grid,{container:!0,gap:.75,alignItems:"center"},Vt.createElement(Ht.Grid,{item:!0,xs:12},Vt.createElement(Ht.FormLabel,{size:"tiny"},r)),Vt.createElement(Ht.Grid,{item:!0,xs:12},i)))),ItemLabel=({value:r})=>{const{position:o,hOffset:i,vOffset:a,blur:c,spread:u}=r.value,{size:p="",unit:g=""}=c?.value||{},{size:v="",unit:b=""}=u?.value||{},{size:k="unset",unit:E=""}=i?.value||{},{size:w="unset",unit:x=""}=a?.value||{},C=o?.value||"outset",_=[[k,E],[w,x],[p,g],[v,b]].map(([r,o])=>"custom"!==o?r+o:r||Ct).join(" ");return Vt.createElement("span",{style:{textTransform:"capitalize"}},C,": ",_)},pr={$$type:"shadow",value:{hOffset:{$$type:"size",value:{unit:"px",size:0}},vOffset:{$$type:"size",value:{unit:"px",size:0}},blur:{$$type:"size",value:{unit:"px",size:10}},spread:{$$type:"size",value:{unit:"px",size:0}},color:{$$type:"color",value:"rgba(0, 0, 0, 1)"},position:null}},dr=__toESM(i(97557)),fr=i(2020),hr=i(27723),mr=__toESM(i(97557)),gr=i(97557),vr=i(2020),yr=i(27723),br=i(27723),kr={blur:{blur:{name:(0,br.__)("Blur","elementor"),valueName:(0,br.__)("Radius","elementor")}},intensity:{brightness:{name:(0,br.__)("Brightness","elementor")},contrast:{name:(0,br.__)("Contrast","elementor")},saturate:{name:(0,br.__)("Saturate","elementor")}},"hue-rotate":{"hue-rotate":{name:(0,br.__)("Hue Rotate","elementor"),valueName:(0,br.__)("Angle","elementor")}},"color-tone":{grayscale:{name:(0,br.__)("Grayscale","elementor")},invert:{name:(0,br.__)("Invert","elementor")},sepia:{name:(0,br.__)("Sepia","elementor")}},"drop-shadow":{"drop-shadow":{name:(0,br.__)("Drop shadow","elementor"),valueName:(0,br.__)("Drop-shadow","elementor")}}},Er=(0,yr.__)("Amount","elementor"),Sr={"drop-shadow":r=>function buildDropShadowDefault(r){const o=r.shape;return{blur:o?.blur?.default,xAxis:o?.xAxis?.default,yAxis:o?.yAxis?.default,color:o?.color?.default??(o?.color).prop_types.color.default}}(r)};function buildFilterConfig(r){const o=Object.entries(kr).flatMap(([o,i])=>Object.entries(i).map(([i,a])=>function createEntry(o,i,{name:a,valueName:c}){const u=function extractPropType(r,o){return r.shape?.args?.prop_types[o]}(r,o),p=Sr[i]?.(u)??function buildSizeDefault(r){const o=r?.shape?.size;return{size:o?.default}}(u),g=function createDefaultValue({filterFunction:r,filterFunctionGroup:o,value:i}){return{$$type:"css-filter-func",value:{func:{$$type:"string",value:r},args:{$$type:o,value:i}}}}({filterFunction:i,filterFunctionGroup:o,value:p});return[i,{name:a,valueName:c??Er,defaultValue:g,filterFunctionGroup:o}]}(o,i,a)));return Object.fromEntries(o)}var wr=(0,gr.createContext)(null);function FilterConfigProvider({children:r}){const o=useBoundProp(vr.cssFilterFunctionPropUtil),i=(0,gr.useMemo)(()=>{const r=buildFilterConfig(o.propType.item_prop_type),i=Object.entries(r).map(([r,o])=>({value:r,label:o.name}));return{config:r,filterOptions:i,getFilterFunctionConfig:o=>r[o],getInitialValue:()=>r.blur.defaultValue}},[o.propType]);return mr.createElement(wr.Provider,{value:i},r)}function useFilterConfig(){const r=(0,gr.useContext)(wr);if(!r)throw new Error("useFilterConfig must be used within FilterConfigProvider");return r}var xr=__toESM(i(97557)),Cr=i(2020),_r=i(79513),Tr=i(27723),Or=__toESM(i(97557)),Pr=i(97557),Ar=i(2020),Mr=i(79513),Nr=i(27723),Rr=[{bind:"xAxis",label:(0,Nr.__)("X-axis","elementor"),rowIndex:0},{bind:"yAxis",label:(0,Nr.__)("Y-axis","elementor"),rowIndex:0},{bind:"blur",label:(0,Nr.__)("Blur","elementor"),rowIndex:1},{bind:"color",label:(0,Nr.__)("Color","elementor"),rowIndex:1}],DropShadowItemContent=({anchorEl:r})=>{const o=useBoundProp(Ar.dropShadowFilterPropTypeUtil),i=[(0,Pr.useRef)(null),(0,Pr.useRef)(null)];return Or.createElement(PropProvider,{...o},Rr.map(o=>Or.createElement(or,{key:o.bind,ref:i[o.rowIndex]??null},Or.createElement(PropKeyProvider,{bind:o.bind},Or.createElement(Mr.Grid,{item:!0,xs:6},Or.createElement(ControlFormLabel,null,o.label)),Or.createElement(Mr.Grid,{item:!0,xs:6},"color"===o.bind?Or.createElement(Ft,{anchorEl:r}):Or.createElement(_t,{anchorRef:i[o.rowIndex],enablePropTypeUnits:!0,min:"blur"===o.bind?0:-Number.MAX_SAFE_INTEGER,defaultUnit:"px"}))))))},Ir=i(97557),Dr=__toESM(i(97557)),Lr=i(2020),Fr=i(79513),zr={blur:Lr.blurFilterPropTypeUtil,intensity:Lr.intensityFilterPropTypeUtil,"hue-rotate":Lr.hueRotateFilterPropTypeUtil,"color-tone":Lr.colorToneFilterPropTypeUtil},SingleSizeItemContent=({filterFunc:r})=>{const o=(0,Ir.useRef)(null),{getFilterFunctionConfig:i}=useFilterConfig(),{valueName:a,filterFunctionGroup:c}=i(r),u=useBoundProp(zr[c]);return Dr.createElement(PropProvider,{...u},Dr.createElement(PropKeyProvider,{bind:c},Dr.createElement(PropKeyProvider,{bind:"size"},Dr.createElement(or,{ref:o},Dr.createElement(Fr.Grid,{item:!0,xs:6},Dr.createElement(ControlFormLabel,null,a)),Dr.createElement(Fr.Grid,{item:!0,xs:6},Dr.createElement(_t,{anchorRef:o,enablePropTypeUnits:!0}))))))},FilterContent=()=>{const r=useBoundProp(Cr.cssFilterFunctionPropUtil),{filterOptions:o,getFilterFunctionConfig:i}=useFilterConfig();return xr.createElement(PropProvider,{...r,setValue:(o,a,c)=>{let u=structuredClone(o);const p=i(u?.func.value);"func"===c?.bind&&(u=p.defaultValue.value),u.args&&r.setValue(u)}},xr.createElement(PropKeyProvider,{bind:"css-filter-func"},xr.createElement(PopoverContent,{p:1.5},xr.createElement(or,null,xr.createElement(_r.Grid,{item:!0,xs:6},xr.createElement(ControlFormLabel,null,(0,Tr.__)("Filter","elementor"))),xr.createElement(_r.Grid,{item:!0,xs:6},xr.createElement(PropKeyProvider,{bind:"func"},xr.createElement(_e,{options:o})))),xr.createElement(PropKeyProvider,{bind:"args"},xr.createElement(FilterValueContent,null)))))},FilterValueContent=()=>{const{openItemIndex:r,items:o}=useRepeaterContext(),i=o[r].item.value.func.value;return"drop-shadow"===i?xr.createElement(DropShadowItemContent,null):xr.createElement(SingleSizeItemContent,{filterFunc:i})},jr=__toESM(i(97557)),Br=i(79513),FilterIcon=({value:r})=>"drop-shadow"!==r.value.func.value?null:jr.createElement(Vr,{size:"inherit",component:"span",value:r.value.args.value?.color.value}),Vr=(0,Br.styled)(Br.UnstableColorIndicator)(({theme:r})=>({borderRadius:r.shape.borderRadius/2+"px"})),$r=__toESM(i(97557)),Ur=__toESM(i(97557)),Hr=i(79513),Wr=i(27723),DropShadowItemLabel=({value:r})=>{const o=r.value.args.value,i=["xAxis","yAxis","blur"].map(r=>"custom"!==o[r]?.value?.unit?`${o[r]?.value?.size??0}${o[r]?.value?.unit??"px"}`:o[r]?.value?.size||Ct);return Ur.createElement(Hr.Box,{component:"span"},Ur.createElement(Hr.Box,{component:"span",style:{textTransform:"capitalize"}},(0,Wr.__)("Drop shadow:","elementor")),` ${i.join(" ")}`)},qr=__toESM(i(97557)),Kr=i(79513),SingleSizeItemLabel=({value:r})=>{const{func:o,args:i}=r.value,{getFilterFunctionConfig:a}=useFilterConfig(),{defaultValue:c}=a(o.value??""),u=c.value.args.value?.size?.value?.unit??Qe[0],{unit:p,size:g}=i.value.size?.value??{unit:u,size:0},v=qr.createElement(Kr.Box,{component:"span",style:{textTransform:"capitalize"}},o.value??"",":");return qr.createElement(Kr.Box,{component:"span"},v," "+("custom"!==p?`${g??0}${p??u}`:g||Ct))},FilterLabel=({value:r})=>"drop-shadow"===r.value.func.value?$r.createElement(DropShadowItemLabel,{value:r}):$r.createElement(SingleSizeItemLabel,{value:r}),Gr={filter:{propTypeUtil:fr.filterPropTypeUtil,label:(0,hr.__)("Filters","elementor")},"backdrop-filter":{propTypeUtil:fr.backdropFilterPropTypeUtil,label:(0,hr.__)("Backdrop filters","elementor")}},Jr=createControl(({filterPropName:r="filter"})=>{const{propTypeUtil:o,label:i}=function ensureFilterConfig(r){if(r&&r in Gr)return Gr[r];return Gr.filter}(r),{propType:a,value:c,setValue:u}=useBoundProp(o);return dr.createElement(FilterConfigProvider,null,dr.createElement(PropProvider,{propType:a,value:c,setValue:u},dr.createElement(Repeater,{propTypeUtil:o,label:i,filterPropName:r})))}),Repeater=({propTypeUtil:r,label:o,filterPropName:i})=>{const{getInitialValue:a}=useFilterConfig();return dr.createElement(ControlRepeater,{initial:a(),propTypeUtil:r},dr.createElement(lr,{label:o},dr.createElement(TooltipAddItemAction,{newItemIndex:0,ariaLabel:"backdrop-filter"===i?"backdrop filter":"filter"})),dr.createElement(ItemsContainer,null,dr.createElement(Item,{Label:FilterLabel,Icon:FilterIcon,actions:dr.createElement(dr.Fragment,null,dr.createElement(DuplicateItemAction,null),dr.createElement(DisableItemAction,null),dr.createElement(RemoveItemAction,null))})),dr.createElement(EditItemPopover,null,dr.createElement(FilterContent,null)))};var Yr=__toESM(i(97557)),Xr=i(97557),Qr={"off-canvas":()=>{const r=window,o=r.elementor.config.document.id,i=r.elementor.$previewContents[0].querySelectorAll(`[data-elementor-id="${o}"] .elementor-widget-off-canvas.elementor-element-edit-mode`);return Array.from(i).map(r=>({label:r.querySelector(".e-off-canvas")?.getAttribute("aria-label")??"",value:r.dataset.id}))},"form-elements":()=>{const r=window,o=r.elementor.config.document.id,i=[`[data-elementor-id="${o}"] input[id]:not([type="hidden"]):not([type="reset"]):not([type="button"])`,`[data-elementor-id="${o}"] select[id]`,`[data-elementor-id="${o}"] textarea[id]`],a=r.elementor.$previewContents[0].querySelectorAll(i.join(", "));return Array.from(a).map(r=>{const o=r.tagName.toLowerCase();return{label:`${r.id} (${"input"===o?r.getAttribute("type"):o})`,value:r.id}})}},Zr=createControl(({collectionId:r,options:o,...i})=>{const a=((r,o)=>{const[i,a]=(0,Xr.useState)(o??[]);return(0,Xr.useEffect)(()=>{r&&Qr[r]?a(Qr[r]()):a(o??[])},[r,o]),i})(r,o);return Yr.createElement(_e,{options:a,...i})}),eo=__toESM(i(97557)),to=i(2020),no=i(79513),ro=__toESM(i(97557)),oo=i(79513);function ChipsList({getLabel:r,getTagProps:o,values:i}){return ro.createElement(ro.Fragment,null,i.map((i,a)=>{const{key:c,...u}=o({index:a});return ro.createElement(oo.Chip,{key:c,label:r(i),size:"tiny",...u})}))}var io=createControl(({options:r,freeChips:o})=>{const{value:i,setValue:a,disabled:c}=useBoundProp(to.stringArrayPropTypeUtil),u=(i||[]).map(r=>to.stringPropTypeUtil.extract(r)).filter(r=>null!==r).map(o=>((r,o)=>o.find(o=>o.value===r)??{label:r,value:r})(o,r));return eo.createElement(ControlActions,null,eo.createElement(no.Autocomplete,{fullWidth:!0,multiple:!0,freeSolo:o,size:"tiny",disabled:c,value:u,filterSelectedOptions:!0,onChange:(r,o)=>{a(o.map(r=>to.stringPropTypeUtil.create("string"==typeof r?r:r.value)))},options:r,getOptionLabel:r=>"string"==typeof r?r:r.label,isOptionEqualToValue:(r,o)=>r.value===o.value,renderInput:r=>eo.createElement(no.TextField,{...r}),renderTags:(r,o)=>eo.createElement(ChipsList,{getLabel:r=>"string"==typeof r?r:r.label,getTagProps:o,values:r})}))}),ao=__toESM(i(97557)),so=i(2020),lo=__toESM(i(97557)),co=i(97557),uo=i(24413),po=i(79513),fo=__toESM(i(97557)),ho=i(79513),ConditionalTooltip=({showTooltip:r,children:o,label:i})=>r&&i?fo.createElement(ho.Tooltip,{title:i,disableFocusListener:!0,placement:"top"},o):o,mo=(0,po.styled)(po.ToggleButtonGroup)`
	${({justify:r})=>`justify-content: ${r};`}
...
`,go=(0,po.styled)(po.ToggleButton,{shouldForwardProp:r=>"isPlaceholder"!==r})`
	${({theme:r,isPlaceholder:o})=>o&&`\n\t\tcolor: ${r.palette.text.tertiary};\n\t\tbackground-color: ${"dark"===r.palette.mode?"rgba(255,255,255,0.04)":"rgba(0,0,0,0.02)"};\n\n\t\t&:hover {\n\t\t\tbackground-color: ${"dark"===r.palette.mode?"rgba(255,255,255,0.08)":"rgba(0,0,0,0.04)"};\n\t\t}\n\t`}
`,vo=lo.forwardRef(({justify:r="end",size:o="tiny",value:i,onChange:a,items:c,maxItems:u,exclusive:p=!1,fullWidth:g=!1,disabled:v,placeholder:b},k)=>{const E=p&&void 0!==u&&c.length>u,w=E?c.slice(u-1):[],x=E?c.slice(0,u-1):c,C="rtl"===(0,po.useTheme)().direction,_=(0,co.useMemo)(()=>{const r=w?.length,o=r?x.length+1:x.length,i=r?"auto":"";return g?`repeat(${o}, 1fr) ${i}`:`repeat(${o}, minmax(0, 25%)) ${i}`},[w?.length,x.length,g]),T=p&&(null==i||""===i),P=!p&&Array.isArray(i)?i.map(r=>"string"==typeof r?r:"").join(" ").trim().split(/\s+/).filter(Boolean):[],A=!p&&0===P.length,N=(R=b,Array.isArray(R)?R.flatMap(r=>"string"==typeof r?r.trim().split(/\s+/).filter(Boolean):[]):"string"==typeof R?R.trim().split(/\s+/).filter(Boolean):[]);var R;return lo.createElement(mo,{ref:k,justify:r,value:i,onChange:(r,o)=>{a(o)},exclusive:p,disabled:v,sx:{direction:C?"rtl /* @noflip */":"ltr /* @noflip */",display:"grid",gridTemplateColumns:_,width:"100%"}},x.map(({label:r,value:i,renderContent:a,showTooltip:c,disabled:u=!1})=>{const p=N.length>0&&N.includes(i)&&(T||A);return lo.createElement(ConditionalTooltip,{key:i,label:r,showTooltip:c||!1},lo.createElement(go,{value:i,"aria-label":r,size:o,fullWidth:g,isPlaceholder:p,disabled:u},lo.createElement(a,{size:o})))}),w.length&&p&&lo.createElement(SplitButtonGroup,{size:o,value:i||null,onChange:a,items:w,fullWidth:g}))}),ControlToggleButtonGroup=r=>lo.createElement(ControlActions,null,lo.createElement(vo,{...r})),SplitButtonGroup=({size:r="tiny",onChange:o,items:i,fullWidth:a,value:c})=>{const u=usePreviewButton(i,c),[p,g]=(0,co.useState)(!1),v=(0,co.useRef)(null),onMenuItemClick=r=>{g(!1),onToggleItem(r)},onToggleItem=r=>{o(r===c?null:r)};return lo.createElement(lo.Fragment,null,lo.createElement(po.ToggleButton,{value:u.value,"aria-label":u.label,size:r,fullWidth:a,onClick:r=>{r.preventDefault(),onMenuItemClick(u.value)}},u.renderContent({size:r})),lo.createElement(po.ToggleButton,{size:r,"aria-expanded":p?"true":void 0,"aria-haspopup":"menu","aria-pressed":void 0,onClick:r=>{g(r=>!r),r.preventDefault()},ref:v,value:"__chevron-icon-button__"},lo.createElement(uo.ChevronDownIcon,{fontSize:r})),lo.createElement(po.Menu,{open:p,onClose:()=>g(!1),anchorEl:v.current,anchorOrigin:{vertical:"bottom",horizontal:"right"},transformOrigin:{vertical:"top",horizontal:"right"},sx:{mt:.5}},i.filter(r=>r.value!==u.value).map(({label:r,value:o})=>lo.createElement(po.MenuItem,{key:o,selected:o===c,onClick:()=>onMenuItemClick(o)},lo.createElement(po.ListItemText,null,lo.createElement(po.Typography,{sx:{fontSize:"14px"}},r))))))},usePreviewButton=(r,o)=>{const[i,a]=(0,co.useState)(r.find(r=>r.value===o)??r[0]);return(0,co.useEffect)(()=>{const i=r.find(r=>r.value===o);i&&a(i)},[r,o]),i},yo=__toESM(i(97557)),bo=__toESM(i(24413)),ko=createControl(({options:r,fullWidth:o=!1,size:i="tiny",exclusive:a=!0,maxItems:c,convertOptions:u=!1})=>{const{value:p,setValue:g,placeholder:v,disabled:b}=useBoundProp(so.stringPropTypeUtil),k=u?(r=>r.map(r=>{const o=r.icon,i=bo[o];return{value:r.value,label:r.label,renderContent:({size:o})=>i?yo.createElement(i,{fontSize:o}):r.label,showTooltip:r.showTooltip,exclusive:r.exclusive}}))(r):r,E=k.filter(r=>r.exclusive).map(r=>r.value),w={items:k,maxItems:c,fullWidth:o,size:i,placeholder:v};return a?ao.createElement(ControlToggleButtonGroup,{...w,value:p??null,onChange:g,disabled:b,exclusive:!0}):ao.createElement(ControlToggleButtonGroup,{...w,value:p?.split(" ")??[],onChange:r=>{const o=r[r.length-1],i=E.includes(o)?[o]:r?.filter(r=>!E.includes(r));g(i?.join(" ")||null)},disabled:b,exclusive:!1})}),Eo=__toESM(i(97557)),So=i(2020),wo=i(79513),isEmptyOrNaN=r=>null==r||""===r||Number.isNaN(Number(r)),renderSuffix=r=>r.meta?.suffix?Eo.createElement(wo.InputAdornment,{position:"end"},Eo.createElement(wo.Typography,{variant:"caption",color:"text.secondary"},r.meta.suffix)):Eo.createElement(Eo.Fragment,null),xo=createControl(({placeholder:r,max:o=Number.MAX_SAFE_INTEGER,min:i=-Number.MAX_SAFE_INTEGER,step:a=1,shouldForceInt:c=!1,startIcon:u,disabled:p})=>{const{value:g,setValue:v,placeholder:b,disabled:k,restoreValue:E,propType:w}=useBoundProp(So.numberPropTypeUtil);return Eo.createElement(ControlActions,null,Eo.createElement(dt,{size:"tiny",type:"number",fullWidth:!0,disabled:p??k,value:isEmptyOrNaN(g)?"":g,onInput:r=>{const{value:a,validity:{valid:u}}=r.target;let p;if(isEmptyOrNaN(a))p=null;else{const r=c?+parseInt(a):Number(a);p=Math.min(Math.max(r,i??Number.MIN_SAFE_INTEGER),o??Number.MAX_SAFE_INTEGER)}v(p,void 0,{validation:()=>u})},onBlur:E,placeholder:r??(isEmptyOrNaN(b)?"":String(b)),inputProps:{step:a,min:i},InputProps:{startAdornment:u?Eo.createElement(wo.InputAdornment,{position:"start",disabled:p??k},u):void 0,endAdornment:renderSuffix(w)}}))}),Co=__toESM(i(97557)),_o=i(97557),To=i(79513),Oo=i(27723);function EqualUnequalSizesControl({label:r,icon:o,tooltipLabel:i,items:a,multiSizePropTypeUtil:c}){const u=(0,_o.useId)(),p=(0,To.usePopupState)({variant:"popover",popupId:u}),g=[(0,_o.useRef)(null),(0,_o.useRef)(null)],{propType:v,disabled:b}=useBoundProp(c),{value:k,setValue:E,placeholder:w}=useBoundProp(),getMultiSizeValues=r=>{if(c.isValid(r))return r.value;const o={};a.forEach(i=>{o[i.bind]=r});const i=c.create(o);return i?.value},x=!p.isOpen,C=getMultiSizeValues(k),_=getMultiSizeValues(w),isEqualValues=r=>{if(!r)return!0;const o=c.create(r),i={};a.forEach(r=>{i[r.bind]=o?.value?.[r.bind]??null});const u=Object.values(i).map(r=>JSON.stringify(r));return u.every(r=>r===u[0])},T=!k&&!isEqualValues(_),P=T||!isEqualValues(C);return Co.createElement(Co.Fragment,null,Co.createElement(To.Grid,{container:!0,gap:2,alignItems:"center",flexWrap:"nowrap",ref:g[0]},Co.createElement(To.Grid,{item:!0,xs:6},x?Co.createElement(ControlLabel,null,r):Co.createElement(ControlFormLabel,null,r)),Co.createElement(To.Grid,{item:!0,xs:6},Co.createElement(To.Stack,{direction:"row",alignItems:"center",gap:1},Co.createElement(To.Box,{flexGrow:1},Co.createElement(_t,{placeholder:P?(0,Oo.__)("Mixed","elementor"):void 0,enablePropTypeUnits:!P||!T,anchorRef:g[0]})),Co.createElement(To.Tooltip,{title:i,placement:"top"},Co.createElement(go,{size:"tiny",value:"check",sx:{marginLeft:"auto"},...(0,To.bindToggle)(p),selected:p.isOpen,isPlaceholder:T,"aria-label":i},o))))),Co.createElement(To.Popover,{disablePortal:!0,disableScrollLock:!0,anchorOrigin:{vertical:"bottom",horizontal:"right"},transformOrigin:{vertical:"top",horizontal:"right"},...(0,To.bindPopover)(p),slotProps:{paper:{sx:{mt:.5,width:g[0].current?.getBoundingClientRect().width}}}},Co.createElement(PropProvider,{propType:v,value:C,placeholder:_,setValue:r=>{isEqualValues(r)?E(Object.values(r)?.pop()??null):E(c.create(r))},isDisabled:()=>b},Co.createElement(PopoverContent,{p:1.5},Co.createElement(or,{ref:g[1]},Co.createElement(MultiSizeValueControl,{item:a[0],rowRef:g[1]}),Co.createElement(MultiSizeValueControl,{item:a[1],rowRef:g[1]})),Co.createElement(or,{ref:g[2]},Co.createElement(MultiSizeValueControl,{item:a[2],rowRef:g[2]}),Co.createElement(MultiSizeValueControl,{item:a[3],rowRef:g[2]}))))))}var MultiSizeValueControl=({item:r,rowRef:o})=>{const{bind:i,label:a,icon:c,ariaLabel:u}=r;return Co.createElement(PropKeyProvider,{bind:i},Co.createElement(To.Grid,{item:!0,xs:6},Co.createElement(To.Grid,{container:!0,gap:.75,alignItems:"center"},Co.createElement(To.Grid,{item:!0,xs:12},Co.createElement(ControlLabel,null,a)),Co.createElement(To.Grid,{item:!0,xs:12},Co.createElement(_t,{startIcon:c,ariaLabel:u,anchorRef:o})))))},Po=__toESM(i(97557)),Ao=i(97557),Mo=i(2020),No=i(74518),Ro=i(24413),Io=i(79513),Do=i(27723),Lo=__toESM(i(97557)),Fo=i(97557),zo=i(2020),jo=__toESM(i(97557)),Bo=i(97557),Vo=i(74518),$o=i(79513),Uo=__toESM(i(97557)),Ho=i(24413),Wo=i(79513),getLengthUnits=()=>window.elementor?.config?.size_units?.length??[],getAngleUnits=()=>window.elementor?.config?.size_units?.angle??[],getTimeUnits=()=>window.elementor?.config?.size_units?.time??[],isExtendedUnit=r=>(window.elementor?.config?.size_units?.extended_units??[]).includes(r),qo=/^[a-zA-Z%]$/,isNumericValue=r=>"number"==typeof r?!isNaN(r):"string"==typeof r&&(""!==r.trim()&&!isNaN(Number(r))),Ko=i(97557),Go="",Jo="auto",Yo="custom",resolveSizeOnUnitChange=(r,o)=>isExtendedUnit(o)?Go:r,resolveFallbackUnit=(r,o,i)=>o.includes(r)?r:i&&o.includes(i)?i:o[0]??"",sanitizeSize=r=>"number"==typeof r&&isNaN(r)?Go:r,Xo=i(97557),useSizeValue=({value:r,setValue:o,units:i,defaultUnit:a})=>{const c=(0,Ko.useMemo)(()=>((r,o)=>{if(!r)return r;const{units:i,defaultUnit:a}=o,c=resolveFallbackUnit(r.unit,i,a);return c===Jo?{size:Go,unit:c}:c===Yo?{size:String(r.size??Go),unit:c}:{size:sanitizeSize(r.size)??Go,unit:c}})(r,{units:i,defaultUnit:a}),[r?.size,r?.unit,a]),[u,p]=useSyncExternalState({external:c,setExternal:(r,i,a)=>{null!==r&&o(r,i,a)},persistWhen:r=>hasChanged(r,c),fallback:()=>((r,o)=>{let[i]=r;return void 0!==o&&(i=resolveFallbackUnit(o,r)),{size:Go,unit:i}})(i,a)}),[g,v]=(({sizeValue:r,setUnit:o,persistWhen:i})=>{const[a,c]=(0,Xo.useState)(r.unit);return(0,Xo.useEffect)(()=>{r.unit!==a&&c(r.unit)},[r.unit,r.size]),[a,r=>{c(r),(isExtendedUnit(r)||i())&&o(r)}]})({sizeValue:u,setUnit:r=>{p({unit:r,size:resolveSizeOnUnitChange(u.size,r)})},persistWhen:()=>Boolean(u.size)||""!==u.size||isExtendedUnit(u.unit)});return{size:u.size,setSize:(r,o=!0)=>{if(isExtendedUnit(g))return;const i=r.trim(),a=Number(i),c={unit:g,size:i&&!isNaN(a)?a:""};p(c,void 0,{validation:()=>o})},unit:g,setUnit:v}},hasChanged=(r,o)=>r?.size!==o?.size||r?.unit!==o?.unit,Qo=__toESM(i(97557)),Zo=(0,i(97557).forwardRef)(({id:r,type:o,value:i,onBlur:a,onKeyUp:c,focused:u,disabled:p,onChange:g,onKeyDown:v,InputProps:b,inputProps:k,placeholder:E},w)=>Qo.createElement(dt,{id:r,ref:w,size:"tiny",fullWidth:!0,type:o,value:i,placeholder:E,onKeyUp:c,focused:u,disabled:p,onKeyDown:v,onInput:g,onBlur:a,InputProps:b,inputProps:k,sx:getCursorStyle(b?.readOnly??!1)})),getCursorStyle=r=>({input:{cursor:r?"default !important":void 0}}),ei=__toESM(i(97557)),ti=i(97557),ni=i(70374),ri=i(79513),oi={display:"flex",flexDirection:"column",justifyContent:"center"},UnitSelector=({value:r,isUnitHighlighted:o,onSelect:i,options:a,disabled:c,menuItemsAttributes:u={},optionLabelOverrides:p={}})=>{const g=(0,ri.usePopupState)({variant:"popover",popupId:(0,ti.useId)()});return ei.createElement(ei.Fragment,null,ei.createElement(ii,{isHighlighted:o,disabled:c,size:"small",...(0,ri.bindTrigger)(g)},p[r]??r),ei.createElement(ri.Menu,{MenuListProps:{dense:!0},...(0,ri.bindMenu)(g)},a.map(r=>ei.createElement(ni.MenuListItem,{key:r,onClick:()=>(r=>{i(r),g.close()})(r),...u?.[r],primaryTypographyProps:{variant:"caption",sx:{...oi,lineHeight:"1"}},menuItemTextProps:{sx:oi}},p[r]??r.toUpperCase()))))},ii=(0,ri.styled)(ri.Button,{shouldForwardProp:r=>"isHighlighted"!==r})(({isHighlighted:r,theme:o})=>({color:r?o.palette.text.primary:o.palette.text.tertiary,font:"inherit",minWidth:"initial",textTransform:"uppercase"})),ai={custom:Uo.createElement(Ho.MathFunctionIcon,{fontSize:"tiny"})},SizeField=({value:r,focused:o,disabled:i,InputProps:a,defaultUnit:c,placeholder:u,onUnitChange:p,startIcon:g,ariaLabel:v,onKeyDown:b,setValue:k,onBlur:E,units:w,min:x,unitSelectorProps:C})=>{const{size:_,unit:T,setSize:P,setUnit:A}=useSizeValue({value:r,setValue:k,units:w,defaultUnit:c}),handleUnitChange=r=>{A(r),p?.(r)},{onUnitKeyDown:N}=(({unit:r,units:o,onUnitChange:i})=>{const{appendKey:a,startsWith:c}=useTypingBuffer();return{onUnitKeyDown:u=>{if(0===o.length)return;const{key:p,altKey:g,ctrlKey:v,metaKey:b}=u;if(g||v||b)return;if(isExtendedUnit(r)&&isNumericValue(p)){const[r]=o;return void(r&&i(r))}if(!qo.test(p))return;u.preventDefault();const k=a(p.toLowerCase()),E=o.find(r=>c(r,k));E&&i(E)}}})({unit:T,onUnitChange:handleUnitChange,units:w}),R=isExtendedUnit(T)?"text":"number";return Uo.createElement(Zo,{disabled:i,focused:o,type:R,value:_,placeholder:u,onBlur:E,onKeyDown:r=>{N(r),b?.(r)},onChange:r=>{const o=r.target.value,i=r.target.validity.valid;P(o,i)},InputProps:{...a,autoComplete:"off",readOnly:isExtendedUnit(T),startAdornment:g&&Uo.createElement(Wo.InputAdornment,{position:"start",disabled:i},g),endAdornment:Uo.createElement(Wo.InputAdornment,{position:"end"},Uo.createElement(UnitSelector,{options:w,value:T,onSelect:handleUnitChange,isUnitHighlighted:shouldHighlightUnit({size:_,unit:T}),...C,optionLabelOverrides:ai}))},inputProps:{min:x,step:"any","aria-label":v}})},shouldHighlightUnit=r=>!!r&&(r.unit===Jo||(Boolean(r.size)||0===r.size)),si=__toESM(i(97557)),li=i(97557),ci=i(70374),ui=i(24413),pi=i(79513),di=i(27723),TextFieldPopover2=({popupState:r,anchorRef:o,value:i,onChange:a,onClose:c})=>{const u=(0,li.useRef)(null);(0,li.useEffect)(()=>{r.isOpen&&requestAnimationFrame(()=>{u.current&&u.current.focus()})},[r.isOpen]);const handleClose=()=>{c?.(),r.close()};return si.createElement(pi.Popover,{disablePortal:!0,slotProps:{paper:{sx:{borderRadius:2,width:o.current?.offsetWidth+"px"}}},...(0,pi.bindPopover)(r),anchorOrigin:{vertical:"bottom",horizontal:"center"},transformOrigin:{vertical:"top",horizontal:"center"},onClose:handleClose},si.createElement(ci.PopoverHeader,{title:(0,di.__)("CSS function","elementor"),onClose:handleClose,icon:si.createElement(ui.MathFunctionIcon,{fontSize:"tiny"})}),si.createElement(pi.TextField,{value:i,onChange:a,onKeyDown:r=>{"enter"===r.key.toLowerCase()&&handleClose()},size:"tiny",type:"text",fullWidth:!0,inputProps:{ref:u},sx:{pt:0,pr:1.5,pb:1.5,pl:1.5}}))},SizeComponent=({anchorRef:r,SizeFieldWrapper:o=jo.Fragment,...i})=>{const a=(0,$o.usePopupState)({variant:"popover"}),c=(0,Vo.useActiveBreakpoint)(),u=i?.value?.unit===Yo,p=i.units.includes(Yo);(0,Bo.useEffect)(()=>{a&&a.isOpen&&a.close()},[c]);const g={"aria-controls":a.isOpen?a.popupId:void 0,"aria-haspopup":!0};return jo.createElement(jo.Fragment,null,jo.createElement(o,null,jo.createElement($o.Box,null,jo.createElement(SizeField,{focused:!!a.isOpen||void 0,onUnitChange:o=>{o===Yo&&r?.current&&a.open(r.current)},InputProps:{...g,onClick:o=>{o.target.closest("input")&&u&&a.open(r?.current)}},unitSelectorProps:{menuItemsAttributes:p?{custom:g}:void 0},...i}))),a.isOpen&&r?.current&&jo.createElement(TextFieldPopover2,{popupState:a,anchorRef:r,value:String(i?.value?.size??""),onChange:r=>{i.setValue({size:r.target.value,unit:Yo})},onClose:()=>{}}))},fi=i(2020),toUnitPlaceholder=r=>({...r,size:""}),pickFirstValid=r=>{const o=r.find(({candidate:r})=>validateSizeValue(r));return o?o.resolve(o.candidate):null},validateSizeValue=r=>{if(!r||"object"!=typeof r)return!1;const o=fi.sizePropTypeUtil.create(r);return fi.sizePropTypeUtil.isValid(o)},resolvePlaceholder=r=>{if("string"==typeof r)return r;const o=r?.size;return void 0!==o?"number"==typeof o?o.toString():o:void 0},getSizeUnits=(r,o)=>(r=>getPropTypeSettings(r)?.available_units)(r)??(r=>({length:getLengthUnits,angle:getAngleUnits,time:getTimeUnits}[r]()))(o),hi=[r=>Boolean(r),r=>null==r?.size||""===r?.size,r=>r?.unit!==Jo,r=>r?.unit!==Yo],mi=createControl(({variant:r="length",placeholder:o,anchorRef:i,startIcon:a,ariaLabel:c,min:u})=>{const{value:p,setValue:g,propType:v,placeholder:b,restoreValue:k}=useBoundProp(zo.sizePropTypeUtil),E=(0,Fo.useRef)(null),{sizeValue:w,placeholder:x}=((r,o,i)=>{const a=i??o;return{sizeValue:pickFirstValid([{candidate:r,resolve:r=>r},{candidate:i,resolve:toUnitPlaceholder},{candidate:o,resolve:toUnitPlaceholder}]),placeholder:Boolean(r)?void 0:resolvePlaceholder(a)}})(p??E.current,b,o),C=getSizeUnits(v,r),_=(r=>getPropTypeSettings(r)?.default_unit)(v);return Lo.createElement(SizeComponent,{units:C,value:w,anchorRef:i,placeholder:x,defaultUnit:_,onBlur:()=>{const r=v.settings.required;(r=>hi.every(o=>o(r)))(p)&&!r&&g(null),r&&k()},setValue:(r,o,i)=>{if(isTransitioningFromExtendedUnit(r,p))return E.current=r,void g(null);g(r,o,{...i,validation:()=>v.settings.required?""!==r.size:!i?.validation||i.validation(r)})},SizeFieldWrapper:ControlActions,startIcon:a,ariaLabel:c,min:u})}),isTransitioningFromExtendedUnit=(r,o)=>!isExtendedUnit(r.unit)&&isExtendedUnit(o?.unit)&&""===r.size,LinkedDimensionsControl=({label:r,isSiteRtl:o=!1,min:i})=>{const a=[(0,Ao.useRef)(null),(0,Ao.useRef)(null)],{disabled:c}=useBoundProp(Mo.sizePropTypeUtil),{value:u,setValue:p,propType:g,placeholder:v,disabled:b}=useBoundProp(Mo.dimensionsPropTypeUtil),{value:k,placeholder:E,setValue:w}=useBoundProp(),inferIsLinked=()=>!Mo.dimensionsPropTypeUtil.isValid(k)&&!(!k&&Mo.dimensionsPropTypeUtil.isValid(E)),[x,C]=(0,Ao.useState)(()=>inferIsLinked()),_=(0,No.useActiveBreakpoint)(),T=Mo.dimensionsPropTypeUtil.isValid(k??E);(0,Ao.useLayoutEffect)(()=>{C(inferIsLinked)},[_,T]);const P=r.toLowerCase(),A=x?Ro.LinkIcon:Ro.DetachIcon,N=(0,Do.__)("Link %s","elementor").replace("%s",P),R=(0,Do.__)("Unlink %s","elementor").replace("%s",P),I=c||b,L={propType:g,value:u,placeholder:v??(x?null:{"block-start":E,"block-end":E,"inline-start":E,"inline-end":E}),setValue:r=>{const o=Object.entries(r).filter(([,r])=>Boolean(r));p(0===o.length?null:Object.fromEntries(o))},isDisabled:()=>b},z=!k&&(v||E),getEffectivePlaceholder=r=>{if(x){const r=getFirstDefined(v);return Mo.sizePropTypeUtil.extract(r)}return Mo.sizePropTypeUtil.extract(v?.[r])};return Po.createElement(PropProvider,{...L},Po.createElement(Io.Stack,{direction:"row",gap:2,flexWrap:"nowrap"},Po.createElement(ControlFormLabel,null,r),Po.createElement(Io.Tooltip,{title:x?R:N,placement:"top"},Po.createElement(go,{"aria-label":x?R:N,size:"tiny",value:"check",selected:x,sx:{marginLeft:"auto"},onChange:()=>{if(C(r=>!r),!Mo.dimensionsPropTypeUtil.isValid(k)){const r=k||null;return r?void w(Mo.dimensionsPropTypeUtil.create({"block-start":r,"block-end":r,"inline-start":r,"inline-end":r})):void w(null)}const r=getFirstDefined(u)??null;w(r||null)},disabled:I,isPlaceholder:z},Po.createElement(A,{fontSize:"tiny"})))),function getCssDimensionProps(r,o){return[[{bind:"block-start",label:(0,Do.__)("Top","elementor"),ariaLabel:(0,Do.sprintf)((0,Do.__)("%s top","elementor"),r),icon:Po.createElement(Ro.SideTopIcon,{fontSize:"tiny"})},{bind:"inline-end",label:o?(0,Do.__)("Left","elementor"):(0,Do.__)("Right","elementor"),ariaLabel:o?(0,Do.sprintf)((0,Do.__)("%s left","elementor"),r):(0,Do.sprintf)((0,Do.__)("%s right","elementor"),r),icon:o?Po.createElement(Ro.SideLeftIcon,{fontSize:"tiny"}):Po.createElement(Ro.SideRightIcon,{fontSize:"tiny"})}],[{bind:"block-end",label:(0,Do.__)("Bottom","elementor"),ariaLabel:(0,Do.sprintf)((0,Do.__)("%s bottom","elementor"),r),icon:Po.createElement(Ro.SideBottomIcon,{fontSize:"tiny"})},{bind:"inline-start",label:o?(0,Do.__)("Right","elementor"):(0,Do.__)("Left","elementor"),ariaLabel:o?(0,Do.sprintf)((0,Do.__)("%s right","elementor"),r):(0,Do.sprintf)((0,Do.__)("%s left","elementor"),r),icon:o?Po.createElement(Ro.SideRightIcon,{fontSize:"tiny"}):Po.createElement(Ro.SideLeftIcon,{fontSize:"tiny"})}]]}(r,o).map((r,o)=>Po.createElement(Io.Stack,{direction:"row",gap:2,flexWrap:"nowrap",key:o,ref:a[o]},r.map(({icon:r,...c})=>Po.createElement(Io.Grid,{container:!0,gap:.75,alignItems:"center",key:c.bind},Po.createElement(Io.Grid,{item:!0,xs:12},Po.createElement(Label,{...c})),Po.createElement(Io.Grid,{item:!0,xs:12},Po.createElement(Control3,{bind:c.bind,ariaLabel:c.ariaLabel,startIcon:r,isLinked:x,placeholder:getEffectivePlaceholder(c.bind)??void 0,anchorRef:a[o],min:i})))))))},Control3=({bind:r,ariaLabel:o,startIcon:i,isLinked:a,placeholder:c,anchorRef:u,min:p})=>a?Po.createElement(mi,{ariaLabel:o,startIcon:i,anchorRef:u,placeholder:c,min:p}):Po.createElement(PropKeyProvider,{bind:r},Po.createElement(mi,{ariaLabel:o,startIcon:i,anchorRef:u,min:p,placeholder:c})),Label=({label:r,bind:o})=>Po.createElement(PropKeyProvider,{bind:o},Po.createElement(ControlLabel,null,r)),getFirstDefined=r=>r?.["block-start"]??r?.["inline-end"]??r?.["block-end"]??r?.["inline-start"];var gi=__toESM(i(97557)),vi=i(97557),yi=i(2020),bi=i(24413),ki=i(79513),Ei=i(27723),Si=__toESM(i(97557)),wi=i(97557),xi=i(70374),Ci=i(79513),_i=i(22444),Ti=i(27723),ItemSelector=({itemsList:r,selectedItem:o,onItemChange:i,onClose:a,sectionWidth:c,title:u,itemStyle:p=()=>({}),onDebounce:g=()=>{},icon:v,disabledItems:b,id:k="item-selector",footer:E,categoryItemContentTemplate:w})=>{const[x,C]=(0,wi.useState)(""),_=((r,o,i)=>r.reduce((r,a)=>{const c=a.items.filter(r=>r.toLowerCase().includes(o.toLowerCase()));return c.length&&(r.push({type:"category",value:a.label}),c.forEach(o=>{r.push({type:"item",value:o,disabled:i?.includes(o)??!1})})),r},[]))(r,x,b),T=v,handleClose=()=>{C(""),a()};return Si.createElement(xi.PopoverBody,{width:c,id:k},Si.createElement(xi.PopoverHeader,{title:u,onClose:handleClose,icon:Si.createElement(T,{fontSize:"tiny"})}),Si.createElement(xi.SearchField,{value:x,onSearch:r=>{C(r)},placeholder:(0,Ti.__)("Search","elementor"),id:k+"-search"}),Si.createElement(Ci.Divider,null),Si.createElement(Ci.Box,{sx:{flex:1,overflow:"auto",minHeight:0}},_.length>0?Si.createElement(ItemList,{itemListItems:_,setSelectedItem:i,handleClose:handleClose,selectedItem:o,itemStyle:p,onDebounce:g,categoryItemContentTemplate:w}):Si.createElement(Ci.Stack,{alignItems:"center",justifyContent:"center",height:"100%",p:2.5,gap:1.5,overflow:"hidden"},Si.createElement(T,{fontSize:"large"}),Si.createElement(Ci.Box,{sx:{maxWidth:160,overflow:"hidden"}},Si.createElement(Ci.Typography,{align:"center",variant:"subtitle2",color:"text.secondary"},(0,Ti.__)("Sorry, nothing matched","elementor")),Si.createElement(Ci.Typography,{variant:"subtitle2",color:"text.secondary",sx:{display:"flex",width:"100%",justifyContent:"center"}},Si.createElement("span",null,"“"),Si.createElement(Ci.Box,{component:"span",sx:{maxWidth:"80%",overflow:"hidden",textOverflow:"ellipsis"}},x),Si.createElement("span",null,"”."))),Si.createElement(Ci.Typography,{align:"center",variant:"caption",color:"text.secondary",sx:{display:"flex",flexDirection:"column"}},(0,Ti.__)("Try something else.","elementor"),Si.createElement(Ci.Link,{color:"secondary",variant:"caption",component:"button",onClick:()=>C("")},(0,Ti.__)("Clear & try again","elementor"))))),E)},ItemList=({itemListItems:r,setSelectedItem:o,handleClose:i,selectedItem:a,itemStyle:c=()=>({}),onDebounce:u=()=>{},categoryItemContentTemplate:p})=>{const g=r.find(r=>r.value===a),v=useDebounce(r=>{r.forEach(r=>{r&&"item"===r.type&&u(r.value)})},100),b=(0,wi.useCallback)(r=>c(r),[c]);return Si.createElement(xi.PopoverMenuList,{items:r,selectedValue:g?.value,onChange:v,onSelect:o,onClose:i,itemStyle:b,"data-testid":"item-list",categoryItemContentTemplate:p})},useDebounce=(r,o)=>{const[i]=(0,wi.useState)(()=>(0,_i.debounce)(r,o));return(0,wi.useEffect)(()=>()=>i.cancel(),[i]),i},enqueueFont=(r,o="editor")=>{const i=window;return i.elementor?.helpers?.enqueueFont?.(r,o)??null},Oi=createControl(({fontFamilies:r,sectionWidth:o,ariaLabel:i})=>{const{value:a,setValue:c,disabled:u,placeholder:p}=useBoundProp(yi.fontFamilyPropTypeUtil),g=(0,ki.usePopupState)({variant:"popover"}),v=!a&&p,b=(0,vi.useMemo)(()=>r.map(({label:r,fonts:o})=>({label:r,items:o})),[r]);return gi.createElement(gi.Fragment,null,gi.createElement(ControlActions,null,gi.createElement(ki.UnstableTag,{id:"font-family-control",variant:"outlined",label:a||p,endIcon:gi.createElement(bi.ChevronDownIcon,{fontSize:"tiny"}),...(0,ki.bindTrigger)(g),fullWidth:!0,disabled:u,"aria-label":i,sx:v?{"& .MuiTag-label":{color:r=>r.palette.text.tertiary},textTransform:"capitalize"}:void 0})),gi.createElement(ki.Popover,{disablePortal:!0,disableScrollLock:!0,anchorOrigin:{vertical:"bottom",horizontal:"right"},transformOrigin:{vertical:"top",horizontal:"right"},sx:{my:1.5},...(0,ki.bindPopover)(g)},gi.createElement(ItemSelector,{id:"font-family-selector",itemsList:b,selectedItem:a,onItemChange:c,onClose:g.close,sectionWidth:o,title:(0,Ei.__)("Font family","elementor"),itemStyle:r=>({fontFamily:r.value}),onDebounce:enqueueFont,icon:bi.TextIcon})))}),Pi=__toESM(i(97557)),Ai=i(2020),Mi=i(79513),Ni=createControl(({placeholder:r,ariaLabel:o})=>{const{value:i,setValue:a,disabled:c,placeholder:u}=useBoundProp(Ai.urlPropTypeUtil),p=r??u??void 0;return Pi.createElement(ControlActions,null,Pi.createElement(Mi.TextField,{size:"tiny",fullWidth:!0,value:i??"",disabled:c,onChange:r=>a(r.target.value),placeholder:p,inputProps:{...o?{"aria-label":o}:{}}}))}),Ri=__toESM(i(97557)),Ii=i(97557),Di=i(70975),Li=i(2020),Fi=i(5527),zi=i(24413),ji=i(78187),Bi=i(79513),Vi=i(22444),$i=i(27723),Ui=__toESM(i(97557)),Hi=i(70975),Wi=i(24413),qi=i(79513),Ki=i(27723),Gi={label:(0,Ki.__)("Learn More","elementor"),href:"https://go.elementor.com/element-link-inside-link-infotip"},Ji={descendant:(0,Ki.__)("To add a link or action to this element, first remove the link or action from the elements inside of it.","elementor"),ancestor:(0,Ki.__)("To add a link or action to this container, first remove the link or action from its parent container.","elementor")};var RestrictedLinkInfotip=({linkInLinkRestriction:r,isVisible:o,children:i})=>{const{shouldRestrict:a,reason:c,elementId:u}=r,p=!(!u||!function isTargetInCurrentDocument(r){if(!r)return!1;const o=(0,Hi.getContainer)(r)?.view?.el;if(!o)return!1;const i=o.closest("[data-elementor-id]")?.getAttribute("data-elementor-id"),a=String((0,Hi.getCurrentDocumentId)()??"");return!(!i||!a||i!==a)}(u)),g=Ui.createElement(qi.Alert,{color:"secondary",icon:Ui.createElement(Wi.InfoCircleFilledIcon,null),size:"small",action:p?Ui.createElement(qi.AlertAction,{sx:{width:"fit-content"},variant:"contained",color:"secondary",onClick:()=>{u&&(0,Hi.selectElement)(u)}},(0,Ki.__)("Take me there","elementor")):void 0},Ui.createElement(qi.AlertTitle,null,(0,Ki.__)("Nested links","elementor")),Ui.createElement(qi.Box,{component:"span"},Ji[c??"descendant"]," ",Ui.createElement(qi.Link,{href:Gi.href,target:"_blank",color:"info.main"},Gi.label)));return a&&o?Ui.createElement(qi.Infotip,{placement:"right",content:g,color:"secondary",slotProps:{popper:{sx:{width:300}}}},Ui.createElement(qi.Box,null,i)):Ui.createElement(Ui.Fragment,null,i)},Yi=__toESM(i(97557)),Xi=i(2020),Qi=i(24413),Zi=i(27723),ea=__toESM(i(97557)),na=i(97557),ra=i(24413),oa=i(79513),ia=(0,na.forwardRef)((r,o)=>{const{options:i,onOptionChange:a,onTextChange:c,allowCustomValues:u=!1,placeholder:p="",minInputLength:g=2,value:v="",startAdornment:b,disablePortal:k=!0,inputProps:E,...w}=r,x=function factoryFilter(r,o,i){if(null===r)return o;const a=String(r||"")?.toLowerCase();if(a.length<i)return new Array(0);return o.filter(r=>String(r.id).toLowerCase().includes(a)||r.label.toLowerCase().includes(a))}(v,i,g).map(({id:r})=>r),C=!!v,_=u||!!v?.toString()?.length?void 0:()=>!0,T="number"==typeof v&&!!findMatchingOption(i,v),P=(v?.toString()?.length??0)>=g&&(!u||x.length>0);return ea.createElement(oa.Autocomplete,{...w,ref:o,forcePopupIcon:!1,disablePortal:k,disableClearable:!0,freeSolo:u,openOnFocus:!1,open:P,value:v?.toString()||"",size:"tiny",onChange:(r,o)=>a(Number(o)),readOnly:T,options:x,getOptionKey:r=>findMatchingOption(i,r)?.id||r,getOptionLabel:r=>findMatchingOption(i,r)?.label||r.toString(),groupBy:isCategorizedOptionPool(i)?r=>findMatchingOption(i,r)?.groupLabel||r:void 0,isOptionEqualToValue:_,filterOptions:()=>x,renderOption:(r,o)=>ea.createElement(oa.Box,{component:"li",...r,key:r.id},findMatchingOption(i,o)?.label??o),renderInput:r=>ea.createElement(TextInput,{params:r,handleChange:r=>c?.(r),allowClear:C,placeholder:p,hasSelectedValue:T,startAdornment:b,extraInputProps:E})})}),TextInput=({params:r,allowClear:o,placeholder:i,handleChange:a,hasSelectedValue:c,startAdornment:u,extraInputProps:p})=>ea.createElement(oa.TextField,{...r,placeholder:i,onChange:r=>{a(r.target.value)},inputProps:{...r.inputProps??{},...p??{}},sx:{"& .MuiInputBase-input":{cursor:c?"default":void 0}},InputProps:{...r.InputProps,startAdornment:u||r.InputProps.startAdornment,endAdornment:ea.createElement(ClearButton,{params:r,allowClear:o,handleChange:a})}}),ClearButton=({allowClear:r,handleChange:o,params:i})=>ea.createElement(oa.InputAdornment,{position:"end"},r&&ea.createElement(oa.IconButton,{size:i.size,onClick:()=>o(null),sx:{cursor:"pointer"}},ea.createElement(ra.XIcon,{fontSize:i.size})));function findMatchingOption(r,o=null){const i=(o||"").toString();return r.find(({id:r})=>i===r.toString())}function isCategorizedOptionPool(r){if(r.length<=1)return!1;return new Set(r.map(r=>r.groupLabel)).size>1}var aa=i(97557),sa=i(2020),la=i(18998),ca=i(22444);function useQueryAutocomplete({url:r,params:o={},minInputLength:i=2,initialQueryValue:a=null,excludeIds:c}){const u=(0,aa.useMemo)(()=>new Set((c??[]).map(String)),[c]),[p,g]=(0,aa.useState)(function generateFirstLoadedOption(r){const o=extractFlatOptionFromQueryValue(r);return o?[o]:[]}(a)),v=(0,aa.useMemo)(()=>(0,ca.debounce)(o=>fetchOptions(r,o).then(r=>{g(formatOptions(filterExcludedOptions(r,u)))}),400),[r,u]);(0,aa.useEffect)(()=>{0===i&&r&&fetchOptions(r,{...o,term:""}).then(r=>{g(formatOptions(filterExcludedOptions(r,u)))})},[r,i,u,o]);return{options:p,updateOptions:a=>{const c=a??"";!r||c.length<i||v({...o,term:c})}}}async function fetchOptions(r,o){if(!o||!r)return[];try{const{data:i}=await(0,la.httpService)().get(r,{params:o});return i.data.value}catch{return[]}}function formatOptions(r){const o=isCategorizedOptionPool(r)?"groupLabel":"label";return r.sort((r,i)=>r[o]&&i[o]?r[o].localeCompare(i[o]):0)}function filterExcludedOptions(r,o){return 0===o.size?r:r.filter(r=>!o.has(String(r.id)))}function extractFlatOptionFromQueryValue(r){const o=sa.numberPropTypeUtil.extract(r?.id),i=sa.stringPropTypeUtil.extract(r?.label);return null===o?null:{id:String(o),label:i||String(o)}}var ua=createControl(r=>{const{value:o,setValue:i}=useBoundProp(Xi.queryPropTypeUtil),{value:a,setValue:c,placeholder:u}=useBoundProp(Xi.urlPropTypeUtil),{allowCustomValues:p=!0,queryOptions:{url:g,params:v={}},placeholder:b=(0,Zi.__)("Search","elementor"),minInputLength:k=2,onSetValue:E,ariaLabel:w}=r||{},{options:x,updateOptions:C}=useQueryAutocomplete({url:g,params:v,minInputLength:k,initialQueryValue:o}),_=o?.id?.value??a;return Yi.createElement(ControlActions,null,Yi.createElement(ia,{options:x,allowCustomValues:p,placeholder:u??b,startAdornment:Yi.createElement(Qi.SearchIcon,{fontSize:"tiny"}),value:_,onOptionChange:r=>{if(null===r)return i(null),void E?.(null);const o={id:Xi.numberPropTypeUtil.create(r),label:Xi.stringPropTypeUtil.create(findMatchingOption(x,r)?.label||null)};i(o),E?.(Xi.queryPropTypeUtil.create(o))},onTextChange:r=>{const o=r?.trim()||"";if(!o)return c(null),void E?.(null);c(o),E?.(Xi.urlPropTypeUtil.create(o)),C(r)},minInputLength:k,disablePortal:!1,inputProps:{...w?{"aria-label":w}:{}}}))}),pa=__toESM(i(97557)),da=i(2020),fa=i(79513),ha=createControl(()=>{const{value:r,setValue:o,disabled:i,placeholder:a}=useBoundProp(da.booleanPropTypeUtil);return pa.createElement(fa.Box,{sx:{display:"flex",justifyContent:"flex-end"}},pa.createElement(fa.Switch,{checked:!(!r&&!a),onChange:r=>{o(r.target.checked)},size:"small",disabled:i,inputProps:{...i?{style:{opacity:0}}:{}}}))}),ma="tiny",ga=createControl(r=>{const{value:o,path:i,setValue:a,...c}=useBoundProp(Li.linkPropTypeUtil),u=c.placeholder,[p,g]=(0,ji.useSessionStorage)(i.join("/")),[v,b]=(0,Ii.useState)(!!o||!!u),{allowCustomValues:k=!0,queryOptions:E,placeholder:w,minInputLength:x=2,context:{elementId:C},label:_=(0,$i.__)("Link","elementor"),ariaLabel:T}=r||{},[P,A]=(0,Ii.useState)((0,Di.getLinkInLinkRestriction)(C,o??u)),N=!v&&P.shouldRestrict,R=(0,Vi.useDebouncedCallback)(()=>{const r=(0,Di.getLinkInLinkRestriction)(C,o??u);r.shouldRestrict&&v&&!u&&(b(!1),null!==o&&a(null)),A(o=>function isSameRestriction(r,o){return r.shouldRestrict===o.shouldRestrict&&r.reason===o.reason&&r.elementId===o.elementId}(o,r)?o:r)},300);(0,Fi.__privateUseListenTo)((0,Fi.commandEndEvent)("document/elements/set-settings"),()=>{R()},[R]),(0,Ii.useEffect)(()=>{R();const handleInlineLinkChanged=()=>{R()};return window.addEventListener("elementor:inline-link-changed",handleInlineLinkChanged),()=>{window.removeEventListener("elementor:inline-link-changed",handleInlineLinkChanged)}},[C,R]);return Ri.createElement(PropProvider,{...c,value:o,setValue:a},Ri.createElement(Bi.Stack,{gap:1.5},Ri.createElement(Bi.Stack,{direction:"row",sx:{justifyContent:"space-between",alignItems:"center",marginInlineEnd:-.75}},Ri.createElement(ControlLabel,null,_),Ri.createElement(RestrictedLinkInfotip,{isVisible:!v,linkInLinkRestriction:P},Ri.createElement(Bi.IconButton,{size:ma,onClick:()=>{if(A((0,Di.getLinkInLinkRestriction)(C,o??u)),P.shouldRestrict&&!v)return;const r=!v;b(r),r||null===o||a(null),r&&p?.value&&a(p.value),g({value:p?.value,meta:{isEnabled:r}})},"aria-label":(0,$i.__)("Toggle link","elementor"),disabled:N},v?Ri.createElement(zi.MinusIcon,{fontSize:ma}):Ri.createElement(zi.PlusIcon,{fontSize:ma})))),Ri.createElement(Bi.Collapse,{in:v,timeout:"auto",unmountOnExit:!0},Ri.createElement(Bi.Stack,{gap:1.5},Ri.createElement(PropKeyProvider,{bind:"destination"},Ri.createElement(ua,{queryOptions:E,allowCustomValues:k,minInputLength:x,placeholder:w,onSetValue:r=>{const i=r?{...o,destination:r}:null;g({...p,value:i})},ariaLabel:T||_})),Ri.createElement(PropKeyProvider,{bind:"isTargetBlank"},Ri.createElement(Bi.Grid,{container:!0,alignItems:"center",flexWrap:"nowrap",justifyContent:"space-between"},Ri.createElement(Bi.Grid,{item:!0},Ri.createElement(ControlFormLabel,null,(0,$i.__)("Open in a new tab","elementor"))),Ri.createElement(Bi.Grid,{item:!0,sx:{marginInlineEnd:-1}},Ri.createElement(ha,null))))))))});var va=__toESM(i(97557)),ya=i(70975),ba=i(2020),ka=i(70374),Ea=i(79513),Sa=i(27723),wa=__toESM(i(97557)),xa=i(70374),Ca=i(79513),_a=i(79513),Ta="secondary",Oa=wa.forwardRef(({children:r,title:o,description:i,alertProps:a,infotipProps:c,...u},p)=>{const g="rtl"===(0,Ca.useTheme)().direction,v=u.isEnabled&&(o||i);return wa.createElement(Ca.Box,{ref:p},v?wa.createElement(_a.DirectionProvider,{rtl:g},wa.createElement(Ca.Infotip,{placement:"right",color:Ta,slotProps:{popper:{modifiers:[{name:"offset",options:{offset:[0,10]}}]}},...c,content:wa.createElement(xa.InfoAlert,{color:Ta,sx:{width:300,px:1.5,py:2},...a},wa.createElement(Ca.Box,{sx:{flexDirection:"column",display:"flex",gap:.5}},wa.createElement(Ca.AlertTitle,null,o),wa.createElement(Ca.Box,null,i)))},r)):r)}),Pa=(0,Ea.styled)(Ea.Select)(()=>({".MuiSelect-select.Mui-disabled":{cursor:"not-allowed"}})),Aa=createControl(r=>{const{options:o,onChange:i,fallbackLabels:a={},context:{elementId:c}}=r,{value:u,setValue:p,disabled:g,placeholder:v}=useBoundProp(ba.stringPropTypeUtil),b=(0,ya.getElementLabel)(c)??"element",k={title:(0,Sa.__)("HTML Tag","elementor"),description:(0,Sa.__)("The tag is locked to 'a' tag because this %s has a link. To pick a different tag, remove the link first.","elementor").replace("%s",b),isEnabled:!!g},findOptionByValue=r=>o.find(o=>o.value===r);return va.createElement(ControlActions,null,va.createElement(Oa,{...k},va.createElement(Pa,{sx:{overflow:"hidden",cursor:g?"not-allowed":void 0},displayEmpty:!0,size:"tiny",renderValue:r=>{if(r)return findOptionByValue(r)?.label||a[r]||r;if(!v)return"";const o=findOptionByValue(v),i=o?.label||v;return va.createElement(Ea.Typography,{component:"span",variant:"caption",color:"text.tertiary"},i)},value:u??"",onChange:r=>{const o=r.target.value||null;i?.(o,u),p(o)},disabled:g,fullWidth:!0},o.map(({label:r,...o})=>va.createElement(ka.MenuListItem,{key:o.value,...o,value:o.value??""},r)))))}),Ma=__toESM(i(97557)),Na=i(97557),Ra=i(2020),Ia=i(79513),Da=i(27723),La=(0,Ra.createArrayPropUtils)(Ra.queryPropTypeUtil.key,Ra.queryPropTypeUtil.schema),Fa=createControl(r=>{const{queryOptions:o,placeholder:i,minInputLength:a=2}=r,{value:c,setValue:u,disabled:p}=useBoundProp(La),g=(0,Na.useMemo)(()=>function extractChips(r){if(!r)return[];return r.map(r=>extractFlatOptionFromQueryValue(r?.value)).filter(r=>null!==r)}(c),[c]),v=(0,Na.useMemo)(()=>g.map(r=>Number(r.id)).filter(r=>Number.isFinite(r)),[g]),{options:b,updateOptions:k}=useQueryAutocomplete({url:o.url,params:o.params,minInputLength:a,excludeIds:v});return Ma.createElement(ControlActions,null,Ma.createElement(Ia.Autocomplete,{multiple:!0,fullWidth:!0,disableClearable:!0,forcePopupIcon:!1,disabled:p,size:"tiny",value:g,options:b,onChange:(r,o)=>{u(o.map(r=>Ra.queryPropTypeUtil.create({id:Ra.numberPropTypeUtil.create(Number(r.id)),label:Ra.stringPropTypeUtil.create(r.label)})))},onInputChange:(r,o)=>{k(o||null)},getOptionLabel:r=>r.label,isOptionEqualToValue:(r,o)=>r.id===o.id,filterOptions:r=>r,renderTags:(r,o)=>Ma.createElement(ChipsList,{getLabel:r=>r.label,getTagProps:o,values:r}),renderInput:r=>Ma.createElement(Ia.TextField,{...r,placeholder:i??(0,Da.__)("Search","elementor")})}))});var za=__toESM(i(97557)),ja=i(97557),Ba=i(70975),Va=i(2020),$a=i(24413),Ua=i(79513),Ha=i(27723),Wa=createControl(({allowedKeys:r,keyConfig:o,label:i=(0,Ha.__)("Filter","elementor"),chipsPlaceholder:a})=>{const{propType:c,value:u,setValue:p}=useBoundProp(Va.queryFilterArrayPropTypeUtil),{settings:g}=(0,Ba.useSelectedElementSettings)(),v=(0,ja.useMemo)(()=>r.filter(r=>function isKeyVisible(r,o){if(!r)return!0;if(!o)return!1;const i=Va.stringPropTypeUtil.extract((0,Va.extractValue)(r.path,o));return null!==i&&r.in.includes(i)}(o[r]?.visibleWhen,g)),[r,o,g]),b=(0,ja.useMemo)(()=>function getUsedKeys(r){const o=r.map(r=>Va.stringPropTypeUtil.extract(r?.value?.key)).filter(r=>!!r);return new Set(o)}(u??[]),[u]),k=(0,ja.useMemo)(()=>v.find(r=>!b.has(r))??null,[v,b]),E=(0,ja.useMemo)(()=>r=>v.map(i=>({value:i,label:o[i]?.label??i,disabled:i!==r&&b.has(i)})),[v,o,b]),w=(0,ja.useMemo)(()=>createItemForKey(v[0]??""),[v]);return za.createElement(PropProvider,{propType:c,value:u,setValue:p},za.createElement(ControlRepeater,{initial:w,propTypeUtil:Va.queryFilterArrayPropTypeUtil},za.createElement(lr,{label:i},za.createElement(AddFilterItemAction,{nextAvailableKey:k,ariaLabel:i})),za.createElement(ItemsContainer,{isSortable:!1},za.createElement(Item,{Icon:EmptyIcon,actions:za.createElement(RemoveItemAction,null),Label:({value:r})=>za.createElement(ItemLabel2,{value:r,keyConfig:o})})),za.createElement(EditItemPopover,null,za.createElement(ItemContent,{keyConfig:o,getKeySelectOptions:E,chipsPlaceholder:a}))))}),AddFilterItemAction=({nextAvailableKey:r,ariaLabel:o})=>{const{addItem:i}=useRepeaterContext(),a=null===r;return za.createElement(Ua.Box,{component:"span",sx:{cursor:a?"not-allowed":"pointer"}},za.createElement(Ua.IconButton,{size:"tiny",disabled:a,onClick:o=>{r&&i(o,{item:createItemForKey(r),index:0})},"aria-label":(0,Ha.sprintf)((0,Ha.__)("Add %s item","elementor"),o.toLowerCase())},za.createElement($a.PlusIcon,{fontSize:"tiny"})))},EmptyIcon=()=>null,ItemLabel2=({value:r,keyConfig:o})=>{const i=Va.stringPropTypeUtil.extract(r?.value?.key),a=i&&o[i]?.label||(0,Ha.__)("Item","elementor"),c=function extractChipLabels(r){return(r?.value??[]).map(r=>Va.stringPropTypeUtil.extract(r?.value?.label)).filter(r=>!!r)}(r?.value?.values),u=[...c,...function extractTaxonomyLabels(r,o){const i=(Va.stringArrayPropTypeUtil.extract(r)??[]).map(r=>Va.stringPropTypeUtil.extract(r)).filter(r=>!!r);if(!i.length)return[];const a=o?.staticOptions??[];return i.map(r=>a.find(o=>o.value===r)?.label??r)}(r?.value?.taxonomies,i?o[i]:void 0)],p=u.length>0?`: ${u.join(", ")}`:"";return za.createElement(Ua.Box,{component:"span"},a,p)};var ItemContent=({keyConfig:r,getKeySelectOptions:o,chipsPlaceholder:i})=>{const a=useBoundProp(Va.queryFilterPropTypeUtil),c=(0,ja.useRef)({}),u=Va.stringPropTypeUtil.extract(a.value?.key),p=u?r[u]:void 0,g=p?.valueType??"chips",v=(0,ja.useMemo)(()=>o(u),[o,u]);return za.createElement(PopoverContent,{p:1.5},za.createElement(PropProvider,{...a,setValue:(r,o,i)=>{if("key"!==i?.bind)return void a.setValue(r,o,i);const u=Va.stringPropTypeUtil.extract(a.value?.key),p=Va.stringPropTypeUtil.extract(r?.key);u&&(c.current[u]={values:a.value?.values??null,taxonomies:a.value?.taxonomies??null});const g=p?c.current[p]:void 0;a.setValue({...r,values:g?.values??null,taxonomies:g?.taxonomies??null},o,i)}},za.createElement(or,{flexWrap:"wrap"},za.createElement(Ua.Grid,{item:!0,xs:12},za.createElement(ControlFormLabel,null,(0,Ha.__)("Type","elementor"))),za.createElement(Ua.Grid,{item:!0,xs:12},za.createElement(PropKeyProvider,{bind:"key"},za.createElement(_e,{options:v})))),"taxonomies"===g&&p?.staticOptions&&za.createElement(or,{flexWrap:"wrap"},za.createElement(Ua.Grid,{item:!0,xs:12},za.createElement(ControlFormLabel,null,p.label)),za.createElement(Ua.Grid,{item:!0,xs:12},za.createElement(PropKeyProvider,{bind:"taxonomies"},za.createElement(io,{options:p.staticOptions})))),"taxonomies"!==g&&p?.queryEndpoint&&za.createElement(or,{flexWrap:"wrap"},za.createElement(Ua.Grid,{item:!0,xs:12},za.createElement(ControlFormLabel,null,p.label)),za.createElement(Ua.Grid,{item:!0,xs:12},za.createElement(PropKeyProvider,{bind:"values"},za.createElement(Fa,{queryOptions:{url:p.queryEndpoint.url,params:p.queryEndpoint.params??{}},placeholder:p.chipsPlaceholder??i}))))))};function createItemForKey(r){return Va.queryFilterPropTypeUtil.create({key:Va.stringPropTypeUtil.create(r),values:null,taxonomies:null})}var qa=__toESM(i(97557)),Ka=i(97557),Ga=i(2020),Ja=i(74518),Ya=i(24413),Xa=i(79513),Qa=i(27723),GapControl=({label:r})=>{const o=(0,Ka.useRef)(null),{disabled:i}=useBoundProp(Ga.sizePropTypeUtil),{value:a,setValue:c,propType:u,placeholder:p,disabled:g}=useBoundProp(Ga.layoutDirectionPropTypeUtil),{value:v,setValue:b,placeholder:k}=useBoundProp(),inferIsLinked=()=>!Ga.layoutDirectionPropTypeUtil.isValid(v)&&!(!v&&Ga.layoutDirectionPropTypeUtil.isValid(k)),[E,w]=(0,Ka.useState)(()=>inferIsLinked()),x=Ga.layoutDirectionPropTypeUtil.isValid(v??k),C=(0,Ja.useActiveBreakpoint)();(0,Ka.useLayoutEffect)(()=>{w(inferIsLinked())},[C,x]);const _=r.toLowerCase(),T=E?Ya.LinkIcon:Ya.DetachIcon,P=(0,Qa.__)("Link %s","elementor").replace("%s",_),A=(0,Qa.__)("Unlink %s","elementor").replace("%s",_),N=i||g,R={propType:u,value:a??(E?null:{row:p?.row,column:p?.column}),setValue:r=>{const o=Object.entries(r).filter(([,r])=>Boolean(r));c(0===o.length?null:Object.fromEntries(o))},placeholder:p},I=!v&&(p||k),getEffectivePlaceholder=r=>{if(E){const r=p?.column??p?.row;return Ga.sizePropTypeUtil.extract(r)}return Ga.sizePropTypeUtil.extract(p?.[r])};return qa.createElement(PropProvider,{...R},qa.createElement(Xa.Stack,{direction:"row",gap:2,flexWrap:"nowrap"},qa.createElement(ControlLabel,null,r),qa.createElement(Xa.Tooltip,{title:E?A:P,placement:"top"},qa.createElement(go,{"aria-label":E?A:P,size:"tiny",value:"check",selected:E,sx:{marginLeft:"auto"},onChange:()=>{if(w(r=>!r),!Ga.layoutDirectionPropTypeUtil.isValid(v)){const r=v||null;return r?void b(Ga.layoutDirectionPropTypeUtil.create({row:r,column:r})):void b(null)}b(a?.column??a?.row??null)},disabled:N,isPlaceholder:I},qa.createElement(T,{fontSize:"tiny"})))),qa.createElement(Xa.Stack,{direction:"row",gap:2,flexWrap:"nowrap",ref:o},qa.createElement(Xa.Grid,{container:!0,gap:.75,alignItems:"center"},qa.createElement(Xa.Grid,{item:!0,xs:12},qa.createElement(ControlFormLabel,null,(0,Qa.__)("Column","elementor"))),qa.createElement(Xa.Grid,{item:!0,xs:12},qa.createElement(Control4,{bind:"column",ariaLabel:(0,Qa.__)("Column gap","elementor"),isLinked:E,anchorRef:o,placeholder:getEffectivePlaceholder("column")??void 0}))),qa.createElement(Xa.Grid,{container:!0,gap:.75,alignItems:"center"},qa.createElement(Xa.Grid,{item:!0,xs:12},qa.createElement(ControlFormLabel,null,(0,Qa.__)("Row","elementor"))),qa.createElement(Xa.Grid,{item:!0,xs:12},qa.createElement(Control4,{bind:"row",ariaLabel:(0,Qa.__)("Row gap","elementor"),isLinked:E,anchorRef:o,placeholder:getEffectivePlaceholder("row")??void 0})))))},Control4=({bind:r,ariaLabel:o,isLinked:i,anchorRef:a,placeholder:c})=>i?qa.createElement(mi,{anchorRef:a,placeholder:c,ariaLabel:o}):qa.createElement(PropKeyProvider,{bind:r},qa.createElement(mi,{anchorRef:a,placeholder:c,ariaLabel:o})),Za=__toESM(i(97557)),es=i(97557),ns=i(2020),rs=i(70374),os=i(24413),as=i(79513),ss=i(27723),ls=[{label:(0,ss.__)("Auto","elementor"),value:"auto"},{label:"1/1",value:"1/1"},{label:"4/3",value:"4/3"},{label:"3/4",value:"3/4"},{label:"16/9",value:"16/9"},{label:"9/16",value:"9/16"},{label:"3/2",value:"3/2"},{label:"2/3",value:"2/3"}],cs="custom",us=createControl(({label:r})=>{const{value:o,setValue:i,disabled:a,placeholder:c}=useBoundProp(ns.stringPropTypeUtil),u=o??c,p=u&&!ls.some(r=>r.value===u),[g,v]=p?u.split("/"):["",""],[b,k]=(0,es.useState)(p),[E,w]=(0,es.useState)(g),[x,C]=(0,es.useState)(v),[_,T]=(0,es.useState)(p?cs:u||"");(0,es.useEffect)(()=>{if(u&&!ls.some(r=>r.value===u)){const[r,o]=u.split("/");w(r||""),C(o||""),T(cs),k(!0)}else T(u||""),k(!1),w(""),C("")},[u]);const P=o??c,A=ls.find(r=>r.value===P);return Za.createElement(ControlActions,null,Za.createElement(as.Stack,{direction:"column",gap:2},Za.createElement(as.Grid,{container:!0,gap:2,alignItems:"center",flexWrap:"nowrap"},Za.createElement(as.Grid,{item:!0,xs:6},Za.createElement(ControlLabel,null,r)),Za.createElement(as.Grid,{item:!0,xs:6},Za.createElement(as.Select,{size:"tiny",displayEmpty:!0,sx:{overflow:"hidden"},disabled:a,value:_,onChange:r=>{const o=r.target.value,a=o===cs;k(a),T(o),a||i(o)},renderValue:p?void 0:()=>A?.label,fullWidth:!0},[...ls,{label:(0,ss.__)("Custom","elementor"),value:cs}].map(({label:r,...o})=>Za.createElement(rs.MenuListItem,{key:o.value,...o,value:o.value??""},r))))),b&&Za.createElement(as.Grid,{container:!0,gap:2,alignItems:"center",flexWrap:"nowrap"},Za.createElement(as.Grid,{item:!0,xs:6},Za.createElement(as.TextField,{size:"tiny",type:"number",fullWidth:!0,disabled:a,value:E,onChange:r=>{const o=r.target.value;w(o),o&&x&&i(`${o}/${x}`)},InputProps:{startAdornment:Za.createElement(os.ArrowsMoveHorizontalIcon,{fontSize:"tiny"})}})),Za.createElement(as.Grid,{item:!0,xs:6},Za.createElement(as.TextField,{size:"tiny",type:"number",fullWidth:!0,disabled:a,value:x,onChange:r=>{const o=r.target.value;C(o),E&&o&&i(`${E}/${o}`)},InputProps:{startAdornment:Za.createElement(os.ArrowsMoveVerticalIcon,{fontSize:"tiny"})}})))))}),ps=__toESM(i(97557)),ds=i(97557),fs=i(46400),hs=i(2020),ms=i(24413),gs=i(79513),vs=i(84792),ys=i(27723),bs=__toESM(i(97557)),ks=i(97557),Es=i(79513),Ss=i(27723),ws=(0,Ss.__)("Enable Unfiltered Uploads","elementor"),xs=(0,Ss.__)("Before you enable unfiltered files upload, note that such files include a security risk. Elementor does run a process to remove possible malicious code, but there is still risk involved when using such files.","elementor"),Cs=(0,Ss.__)("Failed to enable unfiltered files upload.","elementor"),_s=(0,Ss.__)("You can try again, if the problem persists, please contact support.","elementor"),EnableUnfilteredModal=r=>{const{mutateAsync:o,isPending:i}=function useUpdateUnfilteredFilesUpload(){const r=(0,oe.useQueryClient)();return(0,oe.useMutation)({mutationFn:({allowUnfilteredFilesUpload:r})=>apiClient_updateElementorSetting(se,r?"1":"0"),onSuccess:()=>r.invalidateQueries(le)})}(),[a,c]=(0,ks.useState)(!1),u={...r,isPending:i,handleEnable:async()=>{try{const i=await o({allowUnfilteredFilesUpload:!0});!1===i?.data?.success?c(!0):r.onClose(!0)}catch{c(!0)}},isError:a,onClose:o=>{r.onClose(o),setTimeout(()=>c(!1),300)}};return bs.createElement(AdminDialog,{...u})},AdminDialog=({open:r,onClose:o,handleEnable:i,isPending:a,isError:c})=>bs.createElement(Es.Dialog,{open:r,maxWidth:"sm",onClose:()=>o(!1)},bs.createElement(Es.DialogHeader,{logo:!1},bs.createElement(Es.DialogTitle,null,ws)),bs.createElement(Es.Divider,null),bs.createElement(Es.DialogContent,null,bs.createElement(Es.DialogContentText,null,c?bs.createElement(bs.Fragment,null,Cs," ",bs.createElement("br",null)," ",_s):xs)),bs.createElement(Es.DialogActions,null,bs.createElement(Es.Button,{size:"medium",color:"secondary",onClick:()=>o(!1)},(0,Ss.__)("Cancel","elementor")),bs.createElement(Es.Button,{size:"medium",onClick:()=>i(),variant:"contained",color:"primary",disabled:a},a?bs.createElement(Es.CircularProgress,{size:24}):(0,Ss.__)("Enable","elementor")))),Ts="transparent",Os="#c1c1c1",Ps=`linear-gradient(45deg, ${Os} 25%, ${Ts} 0, ${Ts} 75%, ${Os} 0, ${Os})`,As=(0,gs.styled)(gs.Card)`
	background-color: white;
	background-image: ${Ps}, ${Ps};
	background-size: ${8}px ${8}px;
	background-position:
		0 0,
		${4}px ${4}px;
	border: none;
`,Ms=(0,gs.styled)(gs.Stack)`
	position: relative;
	height: 140px;
	object-fit: contain;
	padding: 5px;
