...
var _newPageKitListItem = _interopRequireDefault(__webpack_require__(/*! ./new-page-kit-list-item */ "../app/modules/kit-library/assets/js/components/new-page-kit-list-item.js"));
var _appUi = __webpack_require__(/*! @elementor/app-ui */ "@elementor/app-ui");
...
function HeaderBackButton(props) {
  var navigate = (0, _router.useNavigate)();
  var _useLastFilterContext = (0, _lastFilterContext.useLastFilterContext)(),
...
/***/ "../app/modules/kit-library/assets/js/components/new-page-kit-list-item.js":
/*!*********************************************************************************!*\
  !*** ../app/modules/kit-library/assets/js/components/new-page-kit-list-item.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var NewPageKitListItem = function NewPageKitListItem() {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Card, {
    ...
    tag: "h3",
    title: (0, _i18n.__)('Blank Canvas', 'elementor'),
    variant: "h5",
    className: "eps-card__headline"
    ...
    className: "e-kit-library__kit-item-overlay-overview-button",
    text: (0, _i18n.__)('Create New Elementor Page', 'elementor'),
...
function Index(_ref5) {
  var path = _ref5.path,
    _ref5$initialQueryPar = _ref5.initialQueryParams,
    initialQueryParams = _ref5$initialQueryPar === void 0 ? {} : _ref5$initialQueryPar,
    _ref5$renderNoResults = _ref5.renderNoResultsComponent,
    renderNoResultsComponent = _ref5$renderNoResults === void 0 ? function (_ref6) {
  ...
  var menuItems = (0, _useMenuItems.default)(path);
  var tracking = (0, _trackingContext.useTracking)();
  var _useKits = (0, _useKits2.default)(initialQueryParams),
    data = _useKits.data,
  ...
  useRouterQueryParams(queryParams, setQueryParams, ['ready'].concat((0, _toConsumableArray2.default)(Object.keys(initialQueryParams))));
  (0, _react.useEffect)(function () {
    if (!queryParams.search) {
      return;
    }
...
//# sourceMappingURL=kit-library.816d964bf4c39d277a8e.bundle.js.map